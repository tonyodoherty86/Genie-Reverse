...
TShape::TShape( char *filename, int resource_file_id )
{
    ...
    if( shape_file_first ||
        ...
        if( v5 != -1 ){
            ...
            v8 = this->FShape;
            this->load_type = 1;
            this->shape_info = (Shape_Info *)&v8[1];
            this->load_size = v7;
        }
...
#ifndef SHAPE_FUNC_MINMAX_DEFAULT
    #define SHAPE_FUNC_MINMAX_DEFAULT FALSE
#endif

#ifndef SHAPE_FUNC_MINMAX_CHECK
    #define SHAPE_FUNC_MINMAX_CHECK TRUE
#endif

bool TShape::shape_minmax(
    int *x_min,
    int *y_min,
    int *x_max,
    int *y_max,
...
#if SHAPE_FUNC_MINMAX_CHECK
    case shape_num >= 0 && this->Check_shape(shape_num):
#else
    case shape_num >= 0 && shape_num <= this->FShape->Num_Shapes:
#endif
...
bool TShape::shape_check( int check_x, int check_y, int shape_num )
{
    ...
    int v25; // ebx@33
    int v26; // edi@33
    unsigned char *v27; // eax@33
    int v28; // ecx@33
    int v29; // ebp@35
    int v30; // esi@38
    char v31; // dl@39
    unsigned char v32; // cl@40
    int v33; // ecx@48
    unsigned char v34; // dl@49

    unsigned char check_xa, check_xb;

    char command;

    if( shape_num < 0 || this->Check_shape(shape_num) == true ){
        return false;
    }

    if( this->FShape ){

        v6 = (int)&this->shape_info[shape_num];
        ...
        {
            v10 = 4 * v9;
            v11 = (int)this->FShape + *(_DWORD *)(v6 + 4);
            v12 = *(_WORD *)(v11 + 4 * v9);
            if( v12 >= 0 && v7 >= v12 && v7 <= v8 - *(_WORD *)(v11 + v10 + 2) )
            {
                v13 = &this->FShape->Version[*(_DWORD *)(&this->FShape->Version[*(_DWORD *)v6] + v10)];
                if( v12 < v8 )
                {
                    while( v7 >= v12 )
                    {
                        ...
                        case 0xA:
                            ...
                            v20 = (unsigned int)check_xa >> 4;
                            if( v20 == 0 ){
                                v20 = (unsigned char)*v13++;
                            }
                            v12 += v20;
                            if( v7 < v12 )
                                return true;
    ...
    v23 = (int)&this->shape[this->offsets[shape_num].shape];
    this->shape_header = (Shape_Header *)v23;
    v24 = *(_DWORD *)(v23 + 12);
    v25 = *(_DWORD *)(v23 + 8);
    v26 = *(_DWORD *)(v23 + 16);
    v27 = (unsigned char *)(v23 + 24);
    v28 = *(_DWORD *)(v23 + 20);
    ...
    char *color_table )
{
    ...
    int rect_t; // [sp+20h] [bp-Ch]@12
    int rect_r; // [sp+24h] [bp-8h]@12
    int rect_b; // [sp+28h] [bp-4h]@12
    ...
    if( this->FShape == nullptr){
        ...
        this->shape_header = &this->shape[this->offsets[shape_num].shape];
        v22 = x + this->shape_header->xmax;
        v23 = x + this->shape_header->xmin;
        drawareaa = v23;
        v24 = y + this->shape_header->ymin;
        shape_y1 = y + this->shape_header->ymax;
        v25 = y + this->shape_header->ymax;
        clip_x1 = y + this->shape_header->ymin;
        shape_x1 = x + this->shape_header->xmax;
        clip_x0 = x + this->shape_header->xmax;
        if( v23 < rect_l )
            drawareaa = (TDrawArea *)rect_l;
        if( v24 < rect_t )
            clip_x1 = rect_t;
        if( v22 > rect_r )
            clip_x0 = rect_r;
            ...
            if( v25 >= clip_x1 ){
                if( drawareaa == (TDrawArea *)v23 && clip_x1 == v24 ){
                    if( clip_x0 == shape_x1 && v25 == shape_y1 )
                    {
                        ...
                        case 0:
                            return this->shape_draw_unclipped(
                                v20,
                                v23,
                                v24,
                                shape_num);
                        ...
                        case 1:
                            if( color_table ){
                                return this->shape_color_trans_unclipped(
                                    v20,
                                    v23,
                                    v24,
                                    shape_num,
                        ...
                        case 2:
                            if( color_table ){
                                return this->shape_shadow_unclipped(
                                    v20,
                                    v23,
                                    v24,
                                    color_table);
    ...
    if( SDI_Capture_Info ){
        ...
        Shape_Info *shape_info = (Shape_Info *)&this->FShape[shape_num + 1];

        SDI_List->AddDrawNode(
            this->FShape,
            shape_info,
            SDI_Draw_Line,
            x - shape_info->Hotspot_X,
            y - shape_info->Hotspot_Y,
            fog_next_shape,
            color_table,
            ASMGet_Color_Xform(),
            SDI_Draw_Level,
        ...
        v18 = v7->FShape;
        v19 = (int)&this->FShape[shape_num + 1];
...
bool TShape::shape_draw_unclipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    int shape_num )
{
    ...
    int v6; // esi@1
    int v7; // ebp@1
    unsigned char *v8; // edi@1
    int v9; // eax@1
    int v10; // esi@2
    char *v11; // esi@4
    char v12; // bl@6
    unsigned char v13; // al@7
    bool v14; // zf@16
    int width; // [sp+10h] [bp-4h]@1
    TDrawArea *drawareaa; // [sp+18h] [bp+4h]@5
    int shape_x0a; // [sp+1Ch] [bp+8h]@4
    unsigned char save_buffer; // [sp+20h] [bp+Ch]@8
    unsigned char save_buffera; // [sp+20h] [bp+Ch]@11

    v5 = this->shape_header;
    v6 = drawarea->Orien;
    v7 = v5->ymax - v5->ymin + 1;
    v8 = (unsigned char *)&v5[1];
...
bool TShape::shape_color_trans_unclipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    int shape_num,
        ...
        do
        {
            ...
            do
            {
                ...
                if( (v13 & 1) != 1 )
                {
                    ...
                    memset(v12, (unsigned char)color_table[*v9], save_buffer);
                    v12 += save_buffer;
                    goto LABEL_16;
                }
                if( !(v13 >> 1) )
...
bool TShape::shape_shadow_unclipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    char *color_table )
...
bool TShape::shape_draw_clipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    int clip_x0,
    ...
    int clip_y1 )
{
    ...
    int v10; // eax@1
    int v11; // ecx@1
    unsigned char *v12; // edi@1
    int v13; // eax@2
    int v14; // edx@2
    char *v15; // esi@2
    int v16; // ebp@4
    char v17; // cl@6
    unsigned char v18; // al@7
    int v19; // ebp@17
    unsigned char v20; // al@19
    int v21; // ecx@25
    size_t v22; // ebx@27
    size_t v23; // ebx@35
    unsigned char v24; // al@43
    int v25; // eax@45
    unsigned char v26; // al@59
    bool v27; // zf@66
    char *save_buffer; // [sp+10h] [bp-8h]@4
    int width; // [sp+14h] [bp-4h]@1
    unsigned char drawareaa; // [sp+1Ch] [bp+4h]@20
    unsigned char drawareab; // [sp+1Ch] [bp+4h]@44
    unsigned char drawareac; // [sp+1Ch] [bp+4h]@50
    ...
    v11 = v8 * v10;
    v12 = (unsigned char *)&v9->shape_header[1];
    width = v8 * v10;
    if( v8 >= 1 )
    {
        v13 = clip_y0;
...
bool TShape::shape_color_trans_clipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    int shape_num,
    ...
    char *color_table )
{
    ...
    int v12; // eax@1
    int v13; // ecx@1
    unsigned char *v14; // edi@1
    int v15; // eax@2
    int v16; // edx@2
    char *v17; // esi@2
    int v18; // ebp@4
    char v19; // cl@6
    unsigned char v20; // al@7
    int v21; // ebp@17
    unsigned char v22; // al@19
    int v23; // ecx@27
    int v24; // edx@27
    unsigned char *v25; // edi@27
    int v26; // edx@28
    int v27; // eax@30
    unsigned int v28; // ecx@31
    int v29; // eax@32
    size_t v30; // ebx@39
    unsigned char v31; // al@47
    int v32; // eax@49
    int v33; // ebx@52
    ...
    int v37; // ecx@57
    unsigned char v38; // al@67
    bool v39; // zf@74
    char *save_buffer; // [sp+10h] [bp-Ch]@4
    char *temp_buffer; // [sp+14h] [bp-8h]@27
    int width; // [sp+18h] [bp-4h]@1
    unsigned char drawareaa; // [sp+20h] [bp+4h]@20
    unsigned char drawareab; // [sp+20h] [bp+4h]@48
    unsigned char drawareac; // [sp+20h] [bp+4h]@59
    ...
    v13 = v10 * v12;
    v14 = (unsigned char *)&v11->shape_header[1];
    width = v10 * v12;
    if( v10 >= 1 )
    {
        v15 = clip_y0;
                ...
                do
                {
                    ...
                    else if( v22 >> 1 )
                    {
                        ...
                        if( v21 >= v16 )
                        {
                            ...
                            memset(v17, (unsigned char)color_table[*v14], v30);
                            v16 = clip_x0;
                            v17 += v30;
                        }
                        ++v14;
            ...
            while( !clip_y0c )
            {
                ...
                else
                {
                    ...
                    if( v31 >> 1 )
                    {
                        ...
                        if( v21 <= clip_x1 )
                        {
                            memset(v17, (unsigned char)color_table[*v14], drawareac);
                        }
                        else
                        {
                            clip_y0c = 1;
                            memset(v17, (unsigned char)color_table[*v14], clip_x1 - v21 + drawareac + 1);
                        }
                        v16 = clip_x0;
                        v17 += drawareac;
                        ++v14;
...
bool TShape::shape_shadow_clipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    int clip_x0,
    ...
    char *color_table )
{
    ...
    int v46; // ebx@67
    char v47; // al@71
    unsigned char v48; // cl@72
    bool v49; // zf@80
    char *save_buffer; // [sp+10h] [bp-8h]@4
    int width; // [sp+14h] [bp-4h]@1
    TDrawArea *drawareaa; // [sp+1Ch] [bp+4h]@1
    int shape_y0a; // [sp+24h] [bp+Ch]@17
    unsigned char clip_y0a; // [sp+2Ch] [bp+14h]@20
    unsigned char clip_y0b; // [sp+2Ch] [bp+14h]@21
    unsigned char clip_y0c; // [sp+2Ch] [bp+14h]@34
    unsigned char clip_y0d; // [sp+2Ch] [bp+14h]@49
    unsigned char clip_y0e; // [sp+2Ch] [bp+14h]@50
    unsigned char clip_y0f; // [sp+2Ch] [bp+14h]@60
    ...
    v12 = TDrawArea::AlignedWidth(drawarea);
    v13 = v11 * v12;
    v14 = (unsigned char *)&v10->shape_header[1];
    width = v11 * v12;
...
bool TShape::shape_mirror_unclipped(
    TDrawArea *drawarea,
    int shape_x1,
    int shape_y0 )
{
    ...
    int v8; // ebp@1
    unsigned char *v9; // esi@1
    int v10; // eax@1
    int v11; // ecx@2
    char *v12; // ecx@4
    char *v13; // edi@4
    char v14; // bl@6
    unsigned char v15; // al@7
    int v16; // eax@8
    unsigned char v17; // cl@12
    bool v18; // zf@19
    TDrawArea *drawareaa; // [sp+14h] [bp+4h]@5
    int shape_x1a; // [sp+18h] [bp+8h]@4
    unsigned char save_buffer; // [sp+1Ch] [bp+Ch]@14

    v4 = this;
    v5 = drawarea->Orien;
    v6 = drawarea->AlignedWidth();
    v7 = v4->shape_header;
    v8 = v5 * v6;
...
bool TShape::shape_mirror_color_trans_unclipped(
    TDrawArea *drawarea,
    int shape_x1,
    int shape_y0,
    int shape_num,
    char *color_table )
{
    ...
    int v10; // edx@1
    unsigned char *v11; // esi@1
    char *v12; // edi@2
    char v13; // bl@6
    unsigned char v14; // al@7
    int v15; // eax@8
    int v16; // ecx@12
    bool v17; // zf@19
    int width; // [sp+10h] [bp-4h]@1
    ...
    unsigned char save_buffer; // [sp+20h] [bp+Ch]@14
        ...
        do
        {
            ...
            do
            {
                ...
                if( (v14 & 1) != 1 )
                {
                    ...
                    v12 -= save_buffer;
                    memset(v12, (unsigned char)color_table[*v11], save_buffer);
                    goto LABEL_17;
                }
                LOBYTE(v15) = v14 >> 1;
                if( !(_BYTE)v15 )
...
bool TShape::shape_mirror_shadow_unclipped(
    TDrawArea *drawarea,
    int shape_x1,
    int shape_y0,
    char *color_table )
                ...
                if( (v13 & 1) != 1 )
                {
                    ...
                    if( (_BYTE)v15 )
                    {
                        ...
                        do
                        {
                            --v11;
                            --v15;
                            *v11 = color_table[(unsigned char)*v11];
                        }
                        while( v15 );
                    }
                    goto LABEL_19;
...
bool TShape::shape_mirror_clipped(
    TDrawArea *drawarea,
    int shape_x1,
    int shape_y0,
    int clip_x0,
    ...
    int clip_y1 )
{
    ...
    int v10; // eax@1
    int v11; // ecx@1
    unsigned char *v12; // esi@1
    int v13; // edx@2
    char *v14; // ebp@2
    int v15; // edi@4
    char v16; // cl@6
    unsigned char v17; // al@7
    int v18; // edi@17
    char v19; // bl@18
    unsigned char v20; // al@19
    char *v21; // esi@27
    ...
    unsigned char clip_y0a; // [sp+2Ch] [bp+14h]@20
    unsigned char clip_y0b; // [sp+2Ch] [bp+14h]@49
    unsigned char clip_y0c; // [sp+2Ch] [bp+14h]@60

    v8 = this;
    v9 = drawarea->Orien;
    v10 = TDrawArea::AlignedWidth(drawarea);
    v11 = v9 * v10;
    v12 = (unsigned char *)&v8->shape_header[1];
    width = v9 * v10;
    if( v9 >= 1 )
    {
        v13 = clip_x1;
                    ...
                    if( (v20 & 1) == 1 )
                    {
                        ...
                        if( v20 >> 1 )
                        {
                            ...
                            else
                            {
                                ...
                                v12 = (unsigned char *)&v21[clip_x0 - v18];
                                v13 = clip_x1;
                            }
                        }
                        else
...
LABEL_67:
                ...
                if( (_BYTE)v30 )
                {
                    drawareab = (TDrawArea *)(unsigned char)v30;
                    do
                    {
                        v31 = *v12;
                        --v14;
...
bool TShape::shape_mirror_color_trans_clipped(
    TDrawArea *drawarea,
    int shape_x1,
    int shape_y0,
    int shape_num,
    ...
    char *color_table )
{
    ...
    int v12; // eax@1
    int v13; // ecx@1
    unsigned char *v14; // esi@1
    int v15; // edx@2
    char *v16; // edi@2
    int v17; // ebp@4
    char v18; // cl@6
    unsigned char v19; // al@7
    int v20; // ebp@17
    char v21; // bl@18
    unsigned char v22; // al@19
    unsigned char *v23; // esi@27
    int v24; // eax@28
    int v25; // ecx@29
    int v26; // eax@32
    int v27; // ecx@33
    size_t v28; // eax@40
    char v29; // bl@47
    unsigned char v30; // al@48
    int v31; // eax@50
    int v32; // eax@53
    int v33; // edx@55
    int v34; // eax@60
    char v35; // bl@70
    unsigned char v36; // al@71
    bool v37; // zf@78
    char *save_buffer; // [sp+10h] [bp-8h]@4
    int width; // [sp+14h] [bp-4h]@1
    unsigned char drawareaa; // [sp+1Ch] [bp+4h]@20
    unsigned char drawareab; // [sp+1Ch] [bp+4h]@49
    unsigned char drawareac; // [sp+1Ch] [bp+4h]@62
                ...
                do
                {
                    ...
                    else if( v22 >> 1 )
                    {
                        ...
                        if( v20 <= v15 )
                        {
                            ...
                            v16 -= v28;
                            memset(v16, (unsigned char)color_table[*v14], v28);
                            v15 = clip_x1;
                        }
                        ++v14;
                    }
            ...
            if( !v29 )
            {
                while( 1 )
                {
                    ...
                    if( v30 >> 1 )
                    {
                        ...
                        {
                            v16 -= drawareac;
                            memset(v16, (unsigned char)color_table[*v14], drawareac);
                        }
                        else
                        {
                            v29 = 1;
                            v16 += -drawareac - (v20 - clip_x0);
                            memset(v16, (unsigned char)color_table[*v14], drawareac + v20 - clip_x0);
                        }
                        ++v14;
LABEL_68:
                        v15 = clip_x1;
...
bool TShape::shape_mirror_shadow_clipped(
    TDrawArea *drawarea,
    int shape_x1,
    int shape_y0,
    int clip_x0,
    ...
    char *color_table )
{
    ...
    int v11; // edi@1
    int v12; // eax@1
    unsigned char *v13; // ebp@1
    char *v14; // ecx@2
    int v15; // esi@4
    int v16; // edi@5
    char v17; // al@6
    unsigned char v18; // dl@7
    unsigned char *v19; // edi@17
    int v20; // edx@17
    int v21; // esi@17
    char v22; // al@20
    unsigned char v23; // dl@21
    int v24; // edx@30
    int v25; // edx@34
    int v26; // edx@42
    int v27; // edx@46
    char v28; // al@52
    unsigned char v29; // dl@53
    int v30; // edx@54
    int v31; // edx@55
    int v32; // edx@58
    int v33; // edx@61
    unsigned char v34; // dl@66
    int v35; // edi@68
    int v36; // edx@69
    char v37; // al@78
    unsigned char v38; // cl@79
    bool v39; // zf@86
    char *save_buffer; // [sp+10h] [bp-8h]@4
    int width; // [sp+14h] [bp-4h]@1
    TDrawArea *drawareaa; // [sp+1Ch] [bp+4h]@1
    ...
    int shape_y0a; // [sp+24h] [bp+Ch]@17
    unsigned char clip_y0a; // [sp+2Ch] [bp+14h]@22
    unsigned char clip_y0b; // [sp+2Ch] [bp+14h]@54

    v9 = drawarea;
    v10 = this;
    v11 = drawarea->Orien;
    v12 = v11 * TDrawArea::AlignedWidth(drawarea);
    v13 = (unsigned char *)&v10->shape_header[1];
    width = v12;
                        ...
                        if( v23 >> 1 )
                        {
                            ...
                            if( v21 <= clip_x1 )
                            {
                                if( v21 >= clip_x0 )
                                {
                                    ...
                                    {
                                        v27 = (unsigned char)(clip_x1 - v21);
                                        do
                                        {
                                            --v14;
                                            --v27;
                                            *v14 = color_table[(unsigned char)*v14];
                                        }
                                        while( v27 );
                                    }
                                }
...
LABEL_77:
                ...
                v21 -= (unsigned char)v30;
                if( v21 >= clip_x0 )
                {
                    if( (_BYTE)v30 )
                    {
                        v30 = (unsigned char)v30;
                        do
                        {
                            --v14;
                            --v30;
                ...
                {
                    v28 = 1;
                    v32 = (unsigned char)v30 + v21 - clip_x0;
                    if( (_BYTE)v32 )
                    {
                        v32 = (unsigned char)v32;
                        do
                        {
                            --v14;
                            --v32;
    ...
    int dy )
{
    ...
    if( this->Check_shape(shape_num) != false ){
        return false;
    }

    this->shape_header = &this->shape[this->offsets[shape_num].shape];

    int clip_y0a = this->shape_header->xmin + x;
    int clip_x1a = this->shape_header->ymin + y;
    int clip_x0a = this->shape_header->xmax + x;
    int clip_y1a = this->shape_header->ymax + y;

    int clip_y0 = clip_y0a;
    if( clip_y0 < rectl ){
        clip_y0 = rectl;
    }
    int clip_x1 = clip_x1a;
    if( clip_x1 < rectt ){
        clip_x1 = rectt;
    }
    int clip_x0 = clip_x0a;
    if( clip_x0 > rectr ){
        clip_x0 = rectr;
    }
    int clip_y1 = clip_y1a;
    if( clip_y1 > rectb ){
        clip_y1 = rectb;
    }
    if( clip_y0 < 0 ){
...
bool TShape::shape_dithered_unclipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    int dx,
    int dy )
{
    ...
    int v17; // edi@7
    int i; // edx@9
    unsigned char v19; // al@10
    unsigned char v20; // al@11
    unsigned int v21; // esi@16
    unsigned char v22; // al@21
    unsigned int v23; // esi@25
    char *save_buffer; // [sp+10h] [bp-8h]@4
    int width; // [sp+14h] [bp-4h]@1
    TDrawArea *drawareaa; // [sp+1Ch] [bp+4h]@9
    unsigned char save_flag; // [sp+20h] [bp+8h]@14
    unsigned char save_flaga; // [sp+20h] [bp+8h]@23
...
bool TShape::shape_dithered_clipped(
    TDrawArea *drawarea,
    int shape_x0,
    int shape_y0,
    int clip_x0,
    ...
    int dy )
{
    ...
    unsigned char v60; // [sp+40h] [bp+20h]@30
    unsigned char v61; // [sp+40h] [bp+20h]@36
    unsigned char v62; // [sp+40h] [bp+20h]@47
    unsigned char v63; // [sp+40h] [bp+20h]@53
    unsigned char v64; // [sp+40h] [bp+20h]@71
    unsigned char v65; // [sp+40h] [bp+20h]@77
    unsigned char v66; // [sp+40h] [bp+20h]@88
    unsigned char v67; // [sp+40h] [bp+20h]@94
