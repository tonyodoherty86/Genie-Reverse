...
RGE_Scenario_Header::RGE_Scenario_Header( RGE_Scenario *scenario_info )
{
...
RGE_Scenario_Header::RGE_Scenario_Header( int infile )
{
...
size_t RGE_Scenario_Header::get_size()
{
    char *v1; // edi@1
...
void RGE_Scenario_Header::save( int outfile )
{
    size_t header_size = this->get_size();
    rge_write_uncompressed(outfile, &header_size, 4);

    rge_write_uncompressed(outfile, &this->version, 4);

    if( this->version >= 2 ){
        rge_write_uncompressed(outfile, &this->checksum, 4);
    }

    size_t desc_size = 0;
    if( this->description ){
        desc_size = strlen(this->description) + 1;
    }
...
RGE_Scenario::RGE_Scenario( RGE_Game_World *w )
{
    this->world = w;

    this->time_line = new RGE_Timeline(this->world);

    this->InitializeTextValues();

    this->mission_picture  = 0;
    this->victory_conquest = 1;

    memset(this->player_name, 0, sizeof(this->player_name));
}

RGE_Scenario::RGE_Scenario( int infile, RGE_Game_World *w )
{
...
RGE_Static_Object *RGE_Scenario::get_object_pointer(int obj_ID)
{
    return 0;
}
...
//----- (0048B910) --------------------------------------------------------
void RGE_Scenario::Set_scenario_name(char *str)
{
    if( str )
...
//----- (0048B950) --------------------------------------------------------
void RGE_Scenario::Set_description(char *str)
{
    RGE_Scenario::Set_message(this, str, 0);
}

//----- (0048B960) --------------------------------------------------------
void RGE_Scenario::Set_Cine_PreGame(char *str)
{
    if( str )
...
//----- (0048B9A0) --------------------------------------------------------
void RGE_Scenario::Set_Cine_Victory(char *str)
{
    if( str )
...
//----- (0048B9E0) --------------------------------------------------------
void RGE_Scenario::Set_Cine_Loss(char *str)
{
    if( str )
...
//----- (0048BA20) --------------------------------------------------------
void RGE_Scenario::Set_Mission_Bmp(char *str)
{
    if( str )
...
//----- (0048BA60) --------------------------------------------------------
void RGE_Scenario::Set_BuildList(int which_player, char *str, int WithExtension)
{
    char **v4; // edx@2
...
//----- (0048BAD0) --------------------------------------------------------
void RGE_Scenario::Set_CityPlan(int which_player, char *str, int WithExtension)
{
    char **v4; // edx@2
...
//----- (0048BB40) --------------------------------------------------------
void RGE_Scenario::Set_player_AI(int which_player, char *str, int WithExtension)
{
    char **v4; // edx@2
...
//----- (0048BBB0) --------------------------------------------------------
void RGE_Scenario::Set_Version(float ver)
{
    this->Version = ver;
}

//----- (0048BBC0) --------------------------------------------------------
void RGE_Scenario::Set_player_Type(int which, int t)
{
    if( which >= 0 && which < 16 )
        this->PlType[which] = t;
}
...
//----- (0048BBE0) --------------------------------------------------------
void RGE_Scenario::Set_player_Civ(int which, int c)
{
    if( which >= 0 && which < 16 )
...
//----- (0048BC00) --------------------------------------------------------
void RGE_Scenario::Set_player_Active(int which, int val)
{
    if( which >= 0 && which < 16 )
...
//----- (0048BC20) --------------------------------------------------------
void RGE_Scenario::SetPlayerName(int which, char *Name)
{
...
//----- (0048BCC0) --------------------------------------------------------
char *RGE_Scenario::Get_BuildList(int which_player, int WithExtension)
{
...
//----- (0048BEC0) --------------------------------------------------------
char *RGE_Scenario::Get_CityPlan(int which_player, int WithExtension)
{
    RGE_Scenario *v3; // ebp@1
    signed int v4; // ebx@1
    int v5; // eax@3
...
//----- (0048C0E0) --------------------------------------------------------
char *RGE_Scenario::Get_player_AI(int which_player, int WithExtension)
{
    RGE_Scenario *v3; // ebp@1
    signed int v4; // ebx@1
    int v5; // eax@3
...
//----- (0048C2F0) --------------------------------------------------------
int RGE_Scenario::GetPlayerPosture(int which)
{
    int result; // eax@4
...
//----- (0048C360) --------------------------------------------------------
PlayerName *RGE_Scenario::GetPlayerName(int which)
{
    return &this->player_name[which];
}

//----- (0048C370) --------------------------------------------------------
int RGE_Scenario::Get_player_Type(int which)
{
    int result; // eax@3
...
//----- (0048C390) --------------------------------------------------------
int RGE_Scenario::Get_player_Civ(int which)
{
    int result; // eax@3
...
//----- (0048C3B0) --------------------------------------------------------
int RGE_Scenario::Get_player_Active(int which)
{
    int result; // eax@3
...
//----- (0048C3D0) --------------------------------------------------------
void __fastcall RGE_Scenario::update(RGE_Master_Static_Object **a2)
{
...
//----- (0048C3E0) --------------------------------------------------------
void RGE_Scenario::save(int outfile)
{
    ...
    *(float *)v3 = RGE_Scenario::Get_Version();
    ...
    if( (signed short)length > 0 )
        rge_write(outfile, v2->scenario_name, (signed short)length);
    v10 = v2->description;
    if( v10 )
    {
        length = strlen(v10);
    ...
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->description, (signed short)length);
    v11 = v2->hints;
    if( v11 )
    {
        length = strlen(v11);
    ...
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->hints, (signed short)length);
    v12 = v2->win_message;
    if( v12 )
    {
        length = strlen(v12);
    ...
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->win_message, (signed short)length);
    v13 = v2->loss_message;
    if( v13 )
    {
        length = strlen(v13);
    ...
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->loss_message, (signed short)length);
    ...
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->historicle_notes, (signed short)length);
    length = strlen(v2->Cine_PreGame);
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->Cine_PreGame, (signed short)length);
    length = strlen(v2->Cine_Victory);
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->Cine_Victory, (signed short)length);
    length = strlen(v2->Cine_Loss);
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->Cine_Loss, (signed short)length);
    length = strlen(v2->Mission_Bmp);
    rge_write(outfile, &length, 2);
    if( (signed short)length > 0 )
        rge_write(outfile, v2->Mission_Bmp, (signed short)length);
...
LABEL_54:
    ...
    do
    {
        ...
        rge_write(outfile, &length, 2);
        if( (signed short)length > 0 )
            rge_write(outfile, (void *)*v19, (signed short)length);
        ++v19;
        --v34;
    }
    while( v34 );
    ...
    do
    {
        ...
        rge_write(outfile, &length, 2);
        if( (signed short)length > 0 )
            rge_write(outfile, (void *)*v20, (signed short)length);
        ++v20;
        --v34;
    }
    while( v34 );
    if( *v36 >= 1.08 )
    {
        ...
        do
        {
            ...
            rge_write(outfile, &length, 2);
            if( (signed short)length > 0 )
                rge_write(outfile, (void *)*v21, (signed short)length);
            ++v21;
            --v22;
        }
        while( v22 );
...
//----- (0048CCB0) --------------------------------------------------------
void RGE_Scenario::Set_conquest_victory(char flag)
{
    this->victory_conquest = flag;
}

//----- (0048CCC0) --------------------------------------------------------
char RGE_Scenario::Get_conquest_victory()
{
    return this->victory_conquest;
}

//----- (0048CCD0) --------------------------------------------------------
void RGE_Scenario::add_description(char *new_text)
{
    char **v2; // eax@1
    char *v3; // ecx@1
...
//----- (0048CD10) --------------------------------------------------------
void RGE_Scenario::Set_message(char *str, int message)
{
...
//----- (0048CE40) --------------------------------------------------------
char *RGE_Scenario::Get_message(int message)
{
    char *result; // eax@2
...
//----- (0048CEA0) --------------------------------------------------------
RGE_Scenario_File_Info::RGE_Scenario_File_Info(char *in_filename)
{
...
//----- (0048D4D0) --------------------------------------------------------
char *RGE_Scenario_File_Info::get_scenario_name(int id)
{
    char *result; // eax@3
...
//----- (0048D500) --------------------------------------------------------
RGE_Scenario_Header *RGE_Scenario_File_Info::get_scenario_info(int id)
{
