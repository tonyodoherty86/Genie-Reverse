...
//----- (0040E930) --------------------------------------------------------
void AIPlayPhaseCommand::AIPlayPhaseCommand()
{
    this->groupValue = 0;
    this->typeValue = 0;
    this->value1Value = 0;
...
//----- (0040E950) --------------------------------------------------------
void AIPlayPhaseCommand::AIPlayPhaseCommand(char g, char t, int v1, int v2, int v3)
{
    this->groupValue = g;
    this->typeValue = t;
    this->value1Value = v1;
...
//----- (0040E9C0) --------------------------------------------------------
char *AIPlayPhaseCommand::nameType()
{
    return AIPlayPhaseCommand::convertToNameType(this->typeValue);
}

//----- (0040E9D0) --------------------------------------------------------
int AIPlayPhaseCommand::convertToIntType(char *t)
{
...
//----- (0040EBF0) --------------------------------------------------------
char *AIPlayPhaseCommand::convertToNameType(char t)
{
    char *result; // eax@2
...
//----- (0040EC70) --------------------------------------------------------
void AIPlayPhaseTrigger::AIPlayPhaseTrigger()
{
    this->typeValue = 0;
    this->value1Value = -1;
    this->value2Value = -1;
...
//----- (0040EC90) --------------------------------------------------------
void AIPlayPhaseTrigger::AIPlayPhaseTrigger(char t, int v1, int v2, char p, char n, int r)
{
    this->typeValue = t;
    this->value1Value = v1;
    this->value2Value = v2;
...
//----- (0040ED00) --------------------------------------------------------
char *AIPlayPhaseTrigger::nameType()
{
    return AIPlayPhaseTrigger::convertToNameType(this->typeValue);
}

//----- (0040ED10) --------------------------------------------------------
signed int AIPlayPhaseTrigger::convertToIntType(char *t)
{
    signed int result; // eax@2
...
//----- (0040EFF0) --------------------------------------------------------
char *AIPlayPhaseTrigger::convertToNameType(char t)
{
    char *result; // eax@2
...
AIPlayPhaseCommand *AIPlayPhase::command(int v)
{
...
//----- (0040F130) --------------------------------------------------------
AIPlayPhase *AIPlayPhase::trigger(int v)
{
...
//----- (0040F150) --------------------------------------------------------
int AIPlayPhase::addCommand(AIPlayPhaseCommand *c)
{
    signed int v2; // eax@1
    char *v3; // edx@1
    char *v5; // eax@5
...
//----- (0040F1A0) --------------------------------------------------------
int AIPlayPhase::addTrigger(AIPlayPhaseTrigger *t)
{
    AIPlayPhase *v2; // esi@1
    signed int v3; // eax@1
    char *v4; // edx@1
...
//----- (0040F230) --------------------------------------------------------
void AIPlayGroup::AIPlayGroup()
{
    AIPlayGroup::initialize(this);
}

//----- (0040F240) --------------------------------------------------------
char AIPlayGroup::minimum(int n)
{
    char result; // al@3
...
//----- (0040F260) --------------------------------------------------------
void AIPlayGroup::setMinimum(int n, int v)
{
    if( n >= 0 && n < 6 )
        this->minValue[n] = v;
}
...
//----- (0040F280) --------------------------------------------------------
char AIPlayGroup::maximum(int n)
{
    char result; // al@3
...
//----- (0040F2A0) --------------------------------------------------------
void AIPlayGroup::setMaximum(int n, int v)
{
    if( n >= 0 && n < 6 )
        this->maxValue[n] = v;
}
...
//----- (0040F2E0) --------------------------------------------------------
void AIPlay::AIPlay(AIPlay *this)
{
    AIPlay *v1; // esi@1
...
//----- (0040F380) --------------------------------------------------------
BOOL AIPlay::humanPlay(AIPlay *this)
{
    return this->nameValue[0] == 72 && this->nameValue[1] == 80;
}

//----- (0040F3A0) --------------------------------------------------------
char *AIPlay::typeName(AIPlay *this)
{
    return AIPlay::convertToNameType(this->typeValue);
}

//----- (0040F3B0) --------------------------------------------------------
char AIPlay::targetType(int n)
{
    char result; // al@3
...
//----- (0040F3D0) --------------------------------------------------------
int AIPlay::isTargetType(char v)
{
    int v2; // eax@1
...
//----- (0040F3F0) --------------------------------------------------------
int AIPlay::addTargetType(char v)
{
    int v2; // edx@1
    char v3; // al@2
...
//----- (0040F420) --------------------------------------------------------
char AIPlay::targetCharacteristic(int n)
{
    char result; // al@3
...
//----- (0040F440) --------------------------------------------------------
int AIPlay::isTargetCharacteristic(char v)
{
    int v2; // eax@1
...
//----- (0040F460) --------------------------------------------------------
int AIPlay::addTargetCharacteristic(char v)
{
    int v2; // edx@1
    char v3; // al@2
...
//----- (0040F490) --------------------------------------------------------
int AIPlay::gatherTolerance(int groupID, int phaseID)
{
...
//----- (0040F4E0) --------------------------------------------------------
AIPlayGroup *AIPlay::group(int n)
{
...
//----- (0040F500) --------------------------------------------------------
AIPlayPhase *AIPlay::phase(int n)
{
    AIPlayPhase *result; // eax@3
...
AIPlay *fillGroups(AIPlayStatus *playStatus, int *groupMembers, int numberGroupMembers, RGE_Game_World *world)
{
    ...
    if( numberGroupMembers > 0 )
    {
        ...
        do
        {
            ...
            if( v7
                && (v8 = ((int (*)(RGE_Static_Object *))world->playbook->vfptr->convertUnitToIntType)(v7), v8 >= 0)
                && v8 < 6 )
            {
...
//----- (0040F9B0) --------------------------------------------------------
int AIPlay::groupGivenCommandOnPhase(int gID, int cType, int pID)
{
    int v4; // esi@5
...
//----- (0040FA40) --------------------------------------------------------
signed int AIPlay::convertToIntType(char *t)
{
    signed int result; // eax@2
...
//----- (0040FB60) --------------------------------------------------------
char *AIPlay::convertToNameType(char t)
{
    char *result; // eax@2
...
//----- (0040FBB0) --------------------------------------------------------
int AIPlay::locationsOnMap(int targetX, int targetY, int mapXSize, int mapYSize)
{
...
//----- (0040FC30) --------------------------------------------------------
void AIPlayStatus::AIPlayStatus()
{
...
//----- (0040FCB0) --------------------------------------------------------
int AIPlayStatus::originalHitPoints(int n)
{
    int result; // eax@3
...
//----- (0040FCD0) --------------------------------------------------------
void AIPlayStatus::setOriginalHitPoints(int n, int v)
{
    if( n >= 0 && n < 5 )
...
//----- (0040FD10) --------------------------------------------------------
int AIPlayStatus::numberInGroup(int n)
{
    int result; // eax@1
    signed int v3; // edx@1
...
//----- (0040FD40) --------------------------------------------------------
int AIPlayStatus::numberOfTypeInGroup(int n, int type)
{
    int result; // eax@1
    char *v4; // ecx@1
    signed int v5; // edx@1
...
//----- (0040FD80) --------------------------------------------------------
char AIPlayStatus::group(int uID)
{
    signed int v2; // eax@2
...
//----- (0040FDB0) --------------------------------------------------------
int AIPlayStatus::addGrouping(int uID, char gID, char type)
{
    signed int v4; // eax@1
...
//----- (0040FDF0) --------------------------------------------------------
int AIPlayStatus::removeGrouping(int uID)
{
    signed int v2; // eax@1
...
//----- (0040FE50) --------------------------------------------------------
void AIPlayStatus::copyUnits(int *array, int *count)
{
    signed int v3; // esi@1
...
void AIPlayStatus::load(int infile)
{
    rge_read(infile, &this->playNumberValue, 4);
    rge_read(infile, &this->targetValue, 4);
    rge_read(infile, &this->originalPointValue.xValue, 4);
    rge_read(infile, &this->originalPointValue.yValue, 4);
    rge_read(infile, &this->originalPointValue.zValue, 4);
    rge_read(infile, this->originalHitPointsValue, RGE_AI_PLAY_STATUS_ORIGINAL_HIT_POINTS_COUNT * 4);
    rge_read(infile, &this->currentPhaseValue, 1);
    rge_read(infile, this, 400);
    rge_read(infile, &this->savedAttackerValue, 4);
    rge_read(infile, &this->lastPhaseChangeTimeValue, 4);
}

void AIPlayStatus::save(int outfile)
{
    rge_write(outfile, &this->playNumberValue, 4);
    rge_write(outfile, &this->targetValue, 4);
    rge_write(outfile, &this->originalPointValue.xValue, 4);
    rge_write(outfile, &this->originalPointValue.yValue, 4);
    rge_write(outfile, &this->originalPointValue.zValue, 4);
    rge_write(outfile, this->originalHitPointsValue, RGE_AI_PLAY_STATUS_ORIGINAL_HIT_POINTS_COUNT * 4);
    rge_write(outfile, &this->currentPhaseValue, 1);
    rge_write(outfile, this, 400);
    rge_write(outfile, &this->savedAttackerValue, 4);
    rge_write(outfile, &this->lastPhaseChangeTimeValue, 4);
}

void AIPlayStatus::copy(AIPlayStatus *ps)
{
    signed int v2; // ebp@1
    int v3; // eax@1
    int v4; // esi@1
...
void AIPlayStatus::removeDeadUnits(int gID, RGE_Game_World *world)
{
...
//----- (00410150) --------------------------------------------------------
void AIPlayStatus::resetHitPoints(int gID, RGE_Game_World *world)
{
    int v3; // ebp@1
...
//----- (004101B0) --------------------------------------------------------
void AIPlayBook::AIPlayBook(AIPlayBook *this)
{
    this->numberPlaysValue = 0;
    this->plays = 0;
    this->vfptr = (AIPlayBookVtbl *)&AIPlayBook::`vftable';
}
// 56E970: using guessed type int (*AIPlayBook::`vftable')(void *Memory, unsigned int __flags);

//----- (004101D0) --------------------------------------------------------
AIPlayBook *AIPlayBook::`vector deleting destructor'(unsigned int __flags)
{
    AIPlayBook *v2; // esi@1
...
//----- (00410220) --------------------------------------------------------
int AIPlayBook::loadPlays(char *filename)
{
    AIPlayBook *v2; // ebx@1
    _iobuf *v3; // ebp@3
    int v4; // edi@13
...
//----- (00411480) --------------------------------------------------------
int AIPlayBook::convertTargetNameToIntType(char *t)
{
    int result; // eax@2
...
//----- (004114E0) --------------------------------------------------------
int AIPlayBook::convertTargetCharacteristicNameToIntType(char *t)
{
    int result; // eax@2
...
//----- (00411650) --------------------------------------------------------
int AIPlayBook::convertUnitNameToIntType(char *t)
{
    return -1;
}

//----- (00411660) --------------------------------------------------------
int AIPlayBook::convertUnitToIntType(RGE_Static_Object *obj)
{
    return -1;
}

//----- (0047E480) --------------------------------------------------------
void XYZ::XYZ(XYZ *this)
{
    this->xValue = 0;
    this->yValue = 0;
    this->zValue = 0;
...
//----- (0047E490) --------------------------------------------------------
void XYZ::XYZ(int a, int b, int c)
{
    this->xValue = a;
    this->yValue = b;
    this->zValue = c;
...
//----- (0047E530) --------------------------------------------------------
XYZ *XYZ::operator+(XYZ *result, XYZ *__$ReturnUdt)
{
    XYZ *v3; // eax@1
...
//----- (0047E5D0) --------------------------------------------------------
void XYZ::rotateXYByFacet(XYZ *refPoint, XYZ *rPoint, char facet)
{
    XYZ *v4; // esi@1
    double v5; // st7@2
