...
//----- (00401000) --------------------------------------------------------
void RGE_Action_Attack::RGE_Action_Attack(int infile, RGE_Action_Object *obj_in)
{
  int v4; // edi@1
  ...
  v5->action_type = 9;
  rge_read(infile, &v5->range, 4);
  rge_read(infile, &v5->min_range, 4);
  rge_read(infile, &v5->missile_id, 2);
  rge_read(infile, &v5->fire_missile_at_frame, 2);
  rge_read(infile, &v5->need_to_attack, 1);
  rge_read(infile, &v5->was_same_owner, 1);
  rge_read(infile, &v5->indirect_fire_flag, 1);
  rge_read(infile, &obj_in, 2);
...
//----- (00401140) --------------------------------------------------------
RGE_Static_Object *RGE_Action::get_target_obj2(RGE_Action *this)
{
  return this->target_obj2;
}

//----- (00401150) --------------------------------------------------------
RGE_Action_Attack *RGE_Action_Attack::`vector deleting destructor'(RGE_Action_Attack *this, unsigned int __flags)
{
...
//----- (00401170) --------------------------------------------------------
void RGE_Action_Attack::RGE_Action_Attack(RGE_Action_Object *obj_in, RGE_Static_Object *target_obj_in, RGE_Sprite *move_sprite_in, RGE_Sprite *fight_sprite_in, RGE_Sprite *wait_sprite_in, float range_in, float min_range_in, __int16 missile_id_in, __int16 fire_missile_at_frame_in)
{
...
// 56E058: using guessed type int (*RGE_Action_Attack::`vftable')(void *Memory, unsigned int __flags);

//----- (004012B0) --------------------------------------------------------
void RGE_Action_Attack::RGE_Action_Attack(RGE_Action_Object *obj_in, float x, float y, float z, RGE_Sprite *move_sprite_in, RGE_Sprite *fight_sprite_in, RGE_Sprite *wait_sprite_in, float range_in, float min_range_in, __int16 missile_id_in, __int16 fire_missile_at_frame_in)
{
...
//----- (004013A0) --------------------------------------------------------
void RGE_Action_Attack::~RGE_Action_Attack()
{
...
//----- (004013B0) --------------------------------------------------------
void RGE_Action_Attack::save(int outfile)
{
    int v2; // edi@1
...
//----- (004014B0) --------------------------------------------------------
void RGE_Action_Attack::first_in_stack(@<ecx>, double a2@<st0>, char first_time)
{
    RGE_Action_Attack *v3; // esi@1
...
//----- (00401550) --------------------------------------------------------
void RGE_Action_Attack::set_state(char new_state)
{
    RGE_Action_Attack *v2; // esi@1
    char v3; // al@1
    char v4; // al@3
...
char RGE_Action_Attack::update()
{
    ...
    void (*v10)(RGE_Action *, char); // edi@35
    char v11; // al@35
...
LABEL_20:
        ...
        case 7:
            ...
            if( v11 == 13 || v11 == 4 )
                return 0;
            LODWORD(v9) = ((int (*)(RGE_Action_Attack *, signed int))v10)(v1, 7);
LABEL_38:
            if( v1->need_to_attack )
            {
LABEL_45:
...
//----- (00401AD0) --------------------------------------------------------
int RGE_Action_Attack::work(RGE_Static_Object *obj_in, float x, float y, float z)
{
    RGE_Action_Attack *v5; // esi@1
    char v6; // cl@3
...
//----- (00401B30) --------------------------------------------------------
int RGE_Action_Attack::ready_to_attack(int *rangeState)
{
    RGE_Action_Attack *v2; // esi@1
...
//----- (00401F00) --------------------------------------------------------
void RGE_Action_Attack::copy_obj_sprites(RGE_Master_Action_Object *source, RGE_Task *task, RGE_Task *new_task)
{
    RGE_Sprite *v4; // eax@1
    RGE_Sprite *v5; // eax@5
    RGE_Sprite *v6; // eax@9
