...
//----- (0047E670) --------------------------------------------------------
void __thiscall RGE_Dialog_List::RGE_Dialog_List(RGE_Dialog_List *this, char *name)
{
  RGE_Dialog_List *v2; // esi@1

  v2 = this;
  TListDialog::TListDialog((TListDialog *)&this->vfptr, name);
  v2->vfptr = (TPanelVtbl *)&RGE_Dialog_List::`vftable';
}
// 571CF0: using guessed type int (__thiscall *RGE_Dialog_List::`vftable')(void *Memory, unsigned int __flags);

//----- (0047E690) --------------------------------------------------------
RGE_Dialog_List *__thiscall RGE_Dialog_List::`scalar deleting destructor'(RGE_Dialog_List *this, unsigned int __flags)
{
  RGE_Dialog_List *v2; // esi@1

  v2 = this;
  RGE_Dialog_List::~RGE_Dialog_List(this);
  if ( __flags & 1 )
    operator delete(v2);
  return v2;
}
...
//----- (0047E6B0) --------------------------------------------------------
int __thiscall RGE_Dialog_List::setup(RGE_Dialog_List *this, TScreenPanel *parent_screen, char *info_file_in, int info_id_in, int list_type_in, char *title_in)
{
...
//----- (0047E8C0) --------------------------------------------------------
__int16 __thiscall RGE_Dialog_List::get_list_id(RGE_Dialog_List *this)
{
  __int16 result; // ax@1
...
//----- (0047E8F0) --------------------------------------------------------
RGE_Player *__thiscall RGE_Dialog_List::create_list(RGE_Dialog_List *this)
{
  RGE_Player *result; // eax@2

  if ( this->list_type == 1 )
    result = RGE_Dialog_List::create_object_list(this);
  else
    result = 0;
  return result;
}
...
//----- (0047E910) --------------------------------------------------------
RGE_Player *__thiscall RGE_Dialog_List::create_object_list(RGE_Dialog_List *this)
{
  RGE_Dialog_List *v1; // ebx@1
  RGE_Player *result; // eax@1
  signed __int16 v3; // bp@2
  int v4; // edx@3
  int v5; // esi@3
  ...
  __int16 v13; // dx@15
  signed __int16 j; // [sp+10h] [bp-10h]@11
  int i; // [sp+14h] [bp-Ch]@11
  RGE_Player *player; // [sp+18h] [bp-8h]@1
  signed __int16 end_i; // [sp+1Ch] [bp-4h]@2
...
//----- (0047EAA0) --------------------------------------------------------
int __cdecl rdlg_list_compare(void *arg1, void *arg2)
{
  int v2; // eax@1
  int result; // eax@2
...
//----- (0047EB60) --------------------------------------------------------
__int16 __thiscall RGE_Dialog_List::get_cur_id(RGE_Dialog_List *this)
{
  __int16 result; // ax@2
