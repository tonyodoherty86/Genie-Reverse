...
/**
 * @file    Engine\RGE\Effects.cpp
 * @author  Yvan Burrie
 * @date    2018/07/05
 * @version 1.0
 */

RGE_Effects::RGE_Effects(int infile)
{
...
RGE_Effects::RGE_Effects(char *effect_file)
{
            ...
            if( count > 0 )
            {
                while( 1 )
                {
                    ...
                    else
                    {
                        ...
                        v14 = (signed short)(v12[this_effect_num].effect_list_num - v6) < 0;
                        ...
                        while( 1 )
                        {
                            ...
                            *v17 = (_BYTE)effect_file;
                            ...
                            v14 = (signed short)(v6 - v18[this_effect_num].effect_list_num) < 0;
...
RGE_Effects::~RGE_Effects()
{
    ...
    if( v3 > 0 )
    {
        ...
        while( (signed short)v2 < v1->effect_num );
    }
    if( v1->effects )
    {
        free(v1->effects);
...
void RGE_Effects::save(int outfile)
{
...
void RGE_Effects::do_effect(short current_effect, RGE_Player *player)
{
    RGE_Effect *v3; // ebx@2
    short v4; // di@3
    ...
    if( current_effect < this->effect_num && this->effects[current_effect] ){
            ...
            do
            {
                ...
                switch ( v6 )
                {
                    ...
                    case 1:
                        ...
                        v8 = *(_WORD *)(v7 + 4);
                        v9 = *(float *)(v7 + 8);
                        if( (signed short)v6 > -1 )
                        {
                            if( v8 )
                                ((void (*)(RGE_Player *, int, _DWORD, _DWORD))player->vfptr->add_attribute_num)(
                                    player,
                                    v6,
                                    LODWORD(v9),
                                    0);
