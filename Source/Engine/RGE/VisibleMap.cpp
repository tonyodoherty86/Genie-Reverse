...
/**
 * @file    Engine\RGE\VisibleMap.cpp
 * @author  Yvan Burrie
 * @date    2018/07/07
 * @version 1.0
 */

Visible_Unit_Manager::Visible_Unit_Manager(int Num_Players, int Num_Categories)
{
...
void Visible_Unit_Manager::Update_Unit_Info(int Object_Id, int player_id, int Xpos, int Ypos, int Category, unsigned int PriorUnifiedMap, unsigned int NewUnifiedMap, VISIBLE_UNIT_REC **ObjectPtrs)
{
    ...
    v9 = (unsigned short)(PriorUnifiedMap ^ NewUnifiedMap);
    v30 = this;
    PriorUnifiedMapa = (unsigned short)(PriorUnifiedMap ^ NewUnifiedMap);
...
int Visible_Unit_Manager::GetVisibleUnits(int Xpos, int Ypos, int LOS, int player, int *DesiredTypes, int DesiredCount, int *PlayerListMap)
{
    int v9; // esi@3
    int v10; // eax@5
...
Visible_Resource_Manager::Visible_Resource_Manager(RGE_Player *list_owner, int num_lists)
{
...
Visible_Resource_Manager::Visible_Resource_Manager(int infile, RGE_Player *list_owner)
{
    Visible_Resource_Manager *v3; // esi@1
    size_t *v4; // ebp@1
    int v5; // edi@2
...
void Visible_Resource_Manager::save(int outfile)
{
...
void Visible_Resource_Manager::Process_New_Tiles(RGE_Tile_List *tile_list)
{
...
void Visible_Resource_Manager::AddResource(int Obj_Id, int ObjGroup)
{
...
int Visible_Resource_Manager::Remove_Resource(int Obj_Id, int ObjGroup)
{
    int v3; // edx@2
    int v4; // ebx@2
    int v5; // edx@3
...
VISIBLE_RESOURCE_REC *Visible_Resource_Manager::Get_Closest_Resource(int Xpos, int Ypos, int Zone, int ResType, int *excList, int elSize)
{
...
RGE_Visible_Map::RGE_Visible_Map(RGE_Map *in_map, RGE_Player *in_player)
{
...
void RGE_Visible_Map::RGE_Visible_Map(int infile, RGE_Game_World *theWorld)
{
    ...
    short player_id; // [sp+10h] [bp-4h]@3
...
void RGE_Visible_Map::save(int outfile)
{
...
char RGE_Visible_Map::get_visible(int map_col, int map_row)
{
    RGE_Player *v3; // ecx@1
...
void RGE_Visible_Map::set_all(char vis_flag)
{
    RGE_Visible_Map *v2; // esi@1
    int i; // ecx@1
    int j; // eax@2
...
double RGE_Visible_Map::percentExplored()
{
...
struct LOSTBL **RGE_Visible_Map::get_los_table(int radius, int Square)
{
    int v3; // eax@1
...
int RGE_Visible_Map::explore_terrain(int tx, int ty, int radius, int Square, int UpdateMap, int id)
{
    int v7; // ebx@1
    int v8; // esi@1
...
void RGE_Visible_Map::unexplore_terrain(int tx, int ty, int radius, int Square, int UpdateMap, int id)
{
...
int RGE_Visible_Map::explore_terrain_sq(int tx1, int ty1, int tx2, int ty2, int UpdateMap, int id)
{
    int v7; // ebx@1
...
void RGE_Visible_Map::unexplore_terrain_sq(int tx1, int ty1, int tx2, int ty2, int UpdateMap, int id)
{
    RGE_Visible_Map *v7; // ebx@1
    int v8; // esi@1
    int v9; // edi@1
...
unsigned int RGE_Visible_Map::checksum_visible_inputs()
{
...
RGE_Unified_Visible_Map::RGE_Unified_Visible_Map(int width, int height)
{
...
RGE_Unified_Visible_Map::RGE_Unified_Visible_Map(int infile, RGE_Game_World *world)
{
    RGE_Unified_Visible_Map *v3; // esi@1
...
void RGE_Unified_Visible_Map::load(int infile)
{
...
void RGE_Unified_Visible_Map::save(int outfile)
{
    RGE_Unified_Visible_Map *v2; // esi@1
    int v3; // edi@1
...
int RGE_Visible_Map::checksumVisible()
{
    int result; // eax@1
    int v2; // ebp@1
    int v3; // edi@2
...
unsigned int RGE_Visible_Map::checksumUnifiedVisible()
{
    unsigned int result; // eax@1
    int v2; // edi@2
