...
void __thiscall RGE_View::RGE_View(RGE_View *this)
{
  ...
  v1->vfptr = (TPanelVtbl *)&RGE_View::`vftable';
  v1->cur_render_area = 0;
  v1->calc_draw_count = 0;
  v1->world = 0;
  v1->player = 0;
  v1->map = 0;
  v1->tile_wid = 0;
  ...
  v1->center_scr_col = 0;
  v1->center_scr_row = 0;
  v1->center_scr_col_offset = 0;
  v1->center_scr_row_offset = 0;
  v1->center_map_col = 0;
  v1->center_map_row = 0;
  v1->start_scr_col = 0;
  v1->start_scr_row = 0;
  v1->start_map_col = 0;
  v1->start_map_row = 0;
  v1->map_scr_x_offset = 0;
  v1->map_scr_y_offset = 0;
  LODWORD(v1->last_view_x) = -971228160;
  LODWORD(v1->last_view_y) = -971228160;
  v1->function_mode = 0;
  v1->render_terrain_mode = 0;
  v1->save_area1 = 0;
  v1->save_paint_terrain = -1;
  v1->white_pen = 0;
  v1->red_pen = 0;
  v1->hollow_brush = 0;
  ...
  v1->mouse_last_y = -1;
  v1->movable_object = 0;
  RGE_View::set_selection_area(v1, -1, -1, -1, -1);
  v1->Terrain_Clip_Mask = 0;
  v1->Terrain_Fog_Clip_Mask = 0;
  v1->Master_Clip_Mask = 0;
  v1->LastRenderBits = 0;
  v1->RenderOffsets = 0;
  v1->LastRenderSize = 0;
  v1->Tile_Edge_Tables = 0;
  v1->Black_Edge_Tables = 0;
  v1->Float_X_Delta = 0;
  v1->Float_Y_Delta = 0;
  v1->Float_Scroll_Offsets = 0;
  v1->Float_Scroll_Offsets_Sz = 0;
  v1->Queued_Blits = 0;
  v1->Blit_Queue = 0;
  v1->Blit_Queue_Size = 0;
  v1->Current_Blit = 0;
  v1->Blit_Offset_X = 0;
  v1->Blit_Offset_Y = 0;
  v1->prior_objs = 0;
  v1->futur_objs = 0;
  v2 = v1->pick_list_size;
  v3 = 5;
  do
  {
    *(v2 - 5) = 0;
  ...
  v1->message_panel = 0;
  v1->extra_sprites = 0;
  v1->DispSel_List_Size = 0;
  v1->DispSel_List_Max = 8;
  v1->DispSel_List = (DisplaySelectedObjRec *)calloc(8u, 0x14u);
}
// 5775B8: using guessed type int (__thiscall *RGE_View::`vftable')(void *Memory, unsigned int __flags);

//----- (00533740) --------------------------------------------------------
RGE_View *__thiscall RGE_View::`scalar deleting destructor'(RGE_View *this, unsigned int __flags)
{
  RGE_View *v2; // esi@1
...
//----- (00533940) --------------------------------------------------------
int __thiscall RGE_View::setup(RGE_View *this, TDrawArea *render_area_in, TPanel *parent_panel_in, int x_in, int y_in, int wid_in, int hgt_in, int color_in, int calc_draw_count_in, char *border_line_file)
{
  RGE_View *v10; // esi@1
  TShape *v11; // eax@1
  TShape *v12; // eax@2
...
//----- (00533AC0) --------------------------------------------------------
void __thiscall RGE_View::set_focus(RGE_View *this, int have_focus_in)
{
  RGE_View *v2; // esi@1
...
//----- (00533EC0) --------------------------------------------------------
void __thiscall RGE_View::display_object_selection(RGE_View *this, int id, int duration, int select_type, int reset_type)
{
  RGE_View *v5; // esi@1
  signed int v6; // ebx@1
  int v7; // edx@1
...
//----- (00533F70) --------------------------------------------------------
void __thiscall RGE_View::set_rect(RGE_View *this, int x_in, int y_in, int wid_in, int hgt_in)
{
  RGE_View *v5; // esi@1
  TSpan_List_Manager *v6; // edi@1
  TSpan_List_Manager *v7; // edi@3
  TSpan_List_Manager *v8; // edi@5
  TSpan_List_Manager *v9; // eax@7
  TSpan_List_Manager *v10; // eax@8
  TSpan_List_Manager *v11; // eax@10
  TSpan_List_Manager *v12; // eax@11
  TSpan_List_Manager *v13; // eax@13
  TSpan_List_Manager *v14; // eax@14

  v5 = this;
  TPanel::set_rect((TPanel *)&this->vfptr, x_in, y_in, wid_in, hgt_in);
  RGE_View::calc_draw_vars(v5);
  RGE_View::create_surfaces(v5);
...
//----- (00534420) --------------------------------------------------------
void __thiscall RGE_View::set_redraw(RGE_View *this, TPanel::RedrawMode redraw_mode)
{
  RGE_View *v2; // esi@1
...
//----- (00534440) --------------------------------------------------------
void __thiscall RGE_View::set_world(RGE_View *this, RGE_Game_World *world_in)
{
  RGE_View *v2; // esi@1
  RGE_Map *v3; // ecx@2
  RGE_Map *v4; // eax@2
...
//----- (00534500) --------------------------------------------------------
void __thiscall RGE_View::set_player(RGE_View *this, RGE_Player *player_in)
{
  TPanelVtbl *v2; // edx@1
...
//----- (00534530) --------------------------------------------------------
void __thiscall RGE_View::set_selection_area(RGE_View *this, int sel_col1_in, int sel_row1_in, int sel_col2_in, int sel_row2_in)
{
  RGE_View *v5; // esi@1
  RGE_Map *v6; // ecx@1
  RGE_Map *v7; // ecx@4
...
//----- (005345D0) --------------------------------------------------------
int __thiscall RGE_View::get_selection_area(RGE_View *this, int *sel_col1_in, int *sel_row1_in, int *sel_col2_in, int *sel_row2_in, int fix_coords)
{
  int v6; // edx@1
  int v7; // eax@1
  int result; // eax@5
...
//----- (005346F0) --------------------------------------------------------
void __thiscall RGE_View::CreateBlitQueue(RGE_View *this, tagRECT *src_rect, tagRECT *dest_rect, int xDelta, int yDelta)
{
  RGE_View *v5; // esi@1
  tagRECT *v6; // edx@3
  int v7; // ebx@3
  ...
  tagRECT *dest_recta; // [sp+4Ch] [bp+8h]@33
...
//----- (00534A00) --------------------------------------------------------
void __thiscall RGE_View::ProcessQueuedBlit(RGE_View *this, int WaitIfBusy)
{
  RGE_View *v2; // esi@1
           ...
           1)) )
  {
    ...
    if( !v3
      ...
      || (v5 = (int)&v3[v4].src.left,
          ...
          ((void (__stdcall *)(_DWORD, int, int, _DWORD, tagRECT *, signed int))v2->render_area->DrawSurface->vfptr[2].AddRef)(
...
void __thiscall RGE_View::draw(RGE_View *this)
{
  ...
  int v55; // ecx@91
  int v56; // edx@91
  __int16 old_start_map_row; // [sp+10h] [bp-54h]@8
  int old_start_map_rowa; // [sp+10h] [bp-54h]@15
  __int16 old_start_scr_col; // [sp+14h] [bp-50h]@8
  __int16 old_start_scr_row; // [sp+18h] [bp-4Ch]@8
  __int16 old_map_scr_y_offset; // [sp+1Ch] [bp-48h]@8
  __int16 old_map_scr_y_offseta; // [sp+1Ch] [bp-48h]@13
  TPanelVtbl *v63; // [sp+20h] [bp-44h]@8
  tagRECT clip_rect2; // [sp+24h] [bp-40h]@58
  tagRECT new_rect; // [sp+34h] [bp-30h]@15
  tagRECT old_rect; // [sp+44h] [bp-20h]@15
  tagRECT clip_rect1; // [sp+54h] [bp-10h]@56
      ...
      if( LOWORD(v1->map_scr_x_offset) != (_WORD)v5 || (_WORD)v6 )
      {
        ...
        else
        {
          ...
          if( (signed __int16)v13 < 0 )
          {
            ...
            old_rect.bottom = (signed __int16)v13 + old_start_map_rowa - 1;
            new_rect.top = -(signed __int16)v13;
            new_rect.bottom = old_start_map_rowa - 1;
          }
          else
          {
            v13 = (signed __int16)v13;
            old_rect.top = (signed __int16)v13;
...
void __thiscall RGE_View::update(RGE_View *this)
{
  ...
  if( v2 && (v2->view_x != this->last_view_x || v2->view_y != this->last_view_y) )
  {
    ...
    v7 = v2->view_y - (double)(signed __int16)v3;
    ...
    v1->map_scr_x_offset = *(_WORD *)v21 - (signed __int16)v19;
...
//----- (00535480) --------------------------------------------------------
void __thiscall RGE_View::draw_view(RGE_View *this, char function_mode_in, TDrawArea *draw_area_in)
{
  TDrawArea *v3; // eax@1
  RGE_View *v4; // esi@1
  TDrawArea *v5; // ecx@3
...
void __thiscall RGE_View::draw_object_outline(RGE_View *this)
{
  ...
  __int16 x1; // [sp+38h] [bp-3Ch]@9
  __int16 y2; // [sp+3Ah] [bp-3Ah]@9
  __int16 x4; // [sp+3Ch] [bp-38h]@9
  __int16 y3; // [sp+3Eh] [bp-36h]@9
  __int16 x2; // [sp+40h] [bp-34h]@9
  __int16 y1; // [sp+42h] [bp-32h]@9
  ...
  tagPOINT point; // [sp+58h] [bp-1Ch]@3
...
//----- (005359E0) --------------------------------------------------------
int __thiscall RGE_View::pick(RGE_View *this, char pick_mode_in, char select_level, int x, int y, RGE_Pick_Info *pick_info, RGE_Static_Object *last_picked_object)
{
  char v7; // al@1
  RGE_Pick_Info *v8; // esi@1
  RGE_Pick_Info *v9; // edi@1
  int result; // eax@1
  tagPOINT start_mouse_pos; // [sp+8h] [bp-10h]@1
  tagPOINT mouse_pos; // [sp+10h] [bp-8h]@1
...
//----- (00535A80) --------------------------------------------------------
char __thiscall RGE_View::pick_multi(RGE_View *this, char select_level, int x1, int y1, int x2, int y2)
{
  RGE_View *v6; // edi@1
  int v7; // ebx@1
  int v8; // esi@1
      ...
      do
      {
        if( *(_DWORD *)v20 >= 0 )
        {
          ...
          if( v21 )
          {
            ...
            {
              v22 = (*(int (__thiscall **)(RGE_View *, RGE_Static_Object *, _DWORD))&v6->vfptr[1].gap4[0])(
                      v6,
                      v21,
                      *((_WORD *)v20 + 2));
...
//----- (00535C70) --------------------------------------------------------
int __thiscall RGE_View::pick(RGE_View *this, char function_mode_in, char select_level, tagPOINT *mouse_pos, tagPOINT *start_mouse_pos, void **picked_item, float *item_x, float *item_y, __int16 *item_scr_x, __int16 *item_scr_y)
{
...
//----- (00535CC0) --------------------------------------------------------
int __thiscall RGE_View::pick_weight(RGE_View *this, RGE_Static_Object *obj, int confidence)
{
...
//----- (00535DA0) --------------------------------------------------------
int __thiscall RGE_View::get_tile_screen_coords(RGE_View *this, __int16 find_col, __int16 find_row, __int16 *scr_x, __int16 *scr_y, int drop)
{
  RGE_Map *v6; // esi@6
  int v7; // edx@9
  char v8; // bl@10
...
//----- (00535EB0) --------------------------------------------------------
void __thiscall RGE_View::get_center_screen_pos(RGE_View *this, __int16 *scr_x, __int16 *scr_y)
{
...
//----- (00535FC0) --------------------------------------------------------
void __thiscall RGE_View::get_max_size(RGE_View *this, __int16 *col_num, __int16 *row_num)
{
...
//----- (00535FE0) --------------------------------------------------------
int __thiscall RGE_View::view_function(RGE_View *this, char function_mode_in, char function_parm_in, tagPOINT *mouse_pos, tagPOINT *start_mouse_pos, void **picked_item, float *item_x, float *item_y, __int16 *item_scr_x, __int16 *item_scr_y)
{
  RGE_View *v10; // esi@1
  RGE_Map *v11; // ecx@3
  int v12; // edx@3
  ...
  __int16 map_row; // [sp+18h] [bp-70h]@22
  ...
  __int16 tile_screen_row; // [sp+44h] [bp-44h]@54
...
LABEL_171:
            ...
            if( v21 )
            {
              ...
              v21 = v18 + 24 * (signed __int16)map_col;
              tile_type = *(_BYTE *)(v18 + 24 * (signed __int16)map_col + 4);
              tile = (RGE_Tile *)v21;
                       ...
                       mouse_pos) )
                {
                  if( v21 )
                  {
                    RGE_Map::tile_map_coords(
                      ...
                      v35,
                      v34);
                    v19 = (signed __int16)map_col;
                    *v35 = (double)(signed __int16)map_col + *v35;
...
LABEL_139:
            ...
            v46 = (signed __int16)(col_num + 1 - cur_col_num) < 0;
...
//----- (00536B40) --------------------------------------------------------
int __thiscall RGE_View::view_function_terrain(RGE_View *this, char function_mode_in, tagRECT save_render_rect)
{
  RGE_View *v3; // ebp@1
  int v4; // ebx@1
  int v5; // edx@3
  ...
  tagPOINT CPoint; // [sp+88h] [bp-98h]@187
  tagRECT panel_rect; // [sp+90h] [bp-90h]@206
  ...
  v5 = v3->max_row_num;
  v6 = v3->start_map_row;
  start_map_x = v3->start_map_col;
  text_id = v6;
  v7 = 2 * v5 + 12;
  cols_2_scan = v3->max_col_num + 5;
  v8 = v3->map;
  rows_2_scan = 2 * v5 + 12;
  v9 = v8->map_height;
  Map_Width = v8->map_width;
  v3->function_mode = function_mode_in;
  v10 = v3->map;
  v11 = 0;
  Map_Height = v9;
    ...
    while( 1 )
    {
      if( map_row >= 0 && v19 >= 0 )
      {
        if( map_row < Map_Height && v19 < Map_Width )
        {
          ...
          v24 = v22[v19].screen_xpos - v3->map_scr_x_offset;
          screen_row = *(_WORD *)(v23 + 2) - v3->map_scr_y_offset;
...
draw_this_tile:
                ...
                if( (DClipInfo_Node *)clip_to != LDI )
                {
                  if( !clip_to )
                  {
                    TSpan_List_Manager::SetSpanRegions(
                      ...
                      v3->render_rect.left,
                      v3->render_rect.top,
                      v3->render_rect.right,
                      v3->render_rect.bottom);
                    TSpan_List_Manager::SetSpanRegions(
                      v3->Terrain_Fog_Clip_Mask,
                      v3->render_rect.left,
                      v3->render_rect.top,
                      v3->render_rect.right,
                      v3->render_rect.bottom);
                  ...
                  if( v35 == 1 )
                  {
                    TSpan_List_Manager::SetSpanRegions(
                      v3->Terrain_Clip_Mask,
                      v3->Render_Rect1.left,
                      v3->Render_Rect1.top,
                      v3->Render_Rect1.right,
                  ...
                  if( v35 == 2 )
                  {
                    TSpan_List_Manager::SetSpanRegions(
                      v3->Terrain_Clip_Mask,
                      v3->Render_Rect2.left,
                      v3->Render_Rect2.top,
                      v3->Render_Rect2.right,
          ...
          if( !view_debug_Objects && v23 )
          {
            ...
            DClipInfo_List::SetCaptureLevel(v3->futur_objs, 0, 40);
            fog_next_shape = 0;
            SDI_Capture_Info = 0;
          }
          goto SkipCol;
...
LABEL_130:
  ...
  if( v3->scroll_action == 2 )
    DClipInfo_List::AddGDINode(
      ...
      4,
      20,
      v3->mouse_down_x - save_render_rect.left,
      v3->mouse_down_y - save_render_rect.top,
      v3->mouse_last_x - save_render_rect.left,
      v3->mouse_last_y - save_render_rect.top,
      0,
      0,
      0,
      0,
...
LABEL_157:
        ...
        TShape::shape_draw(
          v48->theShape,
          v3->render_area,
          v48->world_x - v3->map_scr_x_offset,
          v48->world_y - v3->map_scr_y_offset,
          v48->thefacet,
          v48->flags,
          v48->colortable);
      }
  ...
  if( v60->YLine_Size > 0 )
  {
    do
    {
      for( i = v60->Draw_Clip_Nodes[v59]; i; i = i->Next )
      {
        ...
        v3->futur_objs->Draw_Level_Tail[v63] = i;
      }
      v60 = v3->futur_objs;
      ++v59;
    }
  ...
  do
  {
    for( j = v3->futur_objs->Draw_Level_Head[v65]; j; j = j->NextOnLevel )
    {
      if( !j->Node_Type )
      {
        ...
        ASMSet_Surface_Info(
          (int)v3->save_area1->CurDisplayOffsets,
          (int)v67->Line_Head_Ptrs,
          (int)v67->Line_Tail_Ptrs,
          v67->Min_Span_Px,
          v67->Min_Line,
          v67->Max_Span_Px,
          v67->Max_Line);
        ASMSet_Color_Xform(j->Xform_Mask);
        ASMSet_Xlate_Table((int)j->Color_Table);
        v68 = j->Shape;
        ASMDraw_Sprite(
          j->Shape_Base,
          j->Draw_X,
          ...
          v68->Width,
          v68->Height,
          v68->Shape_Data_Offsets,
          v68->Shape_Outline_Offset,
          j->Draw_Flag & 0xFE);
        v69 = v3->Terrain_Fog_Clip_Mask;
        ASMSet_Surface_Info(
          (int)v3->save_area1->CurDisplayOffsets,
          (int)v69->Line_Head_Ptrs,
          (int)v69->Line_Tail_Ptrs,
          v69->Min_Span_Px,
          v69->Min_Line,
          v69->Max_Span_Px,
          v69->Max_Line);
  ...
  for( k = v3->first_child_node; k; k = k->next_node )
  {
    ...
    if( k->panel->active && v80->need_redraw )
    {
      ...
      if( v83 )
      {
        ...
        *((_DWORD *)v3->futur_objs->Draw_Level_Tail + 30) = v83;
      }
    }
  }
...
LABEL_254:
  ...
  else
  {
    ...
    DClipInfo_List::ReclaimAllNodes(v3->prior_objs);
  }
  v3->render_rect.left += save_render_rect.left;
  v104 = v3->Master_Clip_Mask;
  v3->render_rect.top += save_render_rect.top;
  v105 = v3->save_area1;
  v3->render_rect.right += save_render_rect.left;
  v3->render_rect.bottom += save_render_rect.top;
  TDrawArea::PtrSpanCopy(
    ...
    v3->render_rect.top,
    &v105->ClipRect,
    (char **)v104->Line_Head_Ptrs);
  RGE_View::Update_Render_Pointers(v3);
  v3->render_rect.left -= save_render_rect.left;
  v3->render_rect.top -= save_render_rect.top;
  v3->render_rect.right -= save_render_rect.left;
  v106 = v3->Master_Clip_Mask;
  v3->render_rect.bottom -= save_render_rect.top;
  ASMSet_Surface_Info(
    (int)v3->RenderOffsets,
    (int)v106->Line_Head_Ptrs,
    (int)v106->Line_Tail_Ptrs,
    v106->Min_Span_Px,
    v106->Min_Line,
    v106->Max_Span_Px,
    v106->Max_Line);
  v107 = 24;
  v3->render_area->CurSpanList = v3->Master_Clip_Mask;
  newFacet = 24;
  do
  {
    ...
    if( v108 )
    {
      do
      {
        ...
        else
        {
          ...
          ASMSet_Color_Xform(*(_DWORD *)(v108 + 40));
          ASMSet_Xlate_Table(*(_DWORD *)(v108 + 36));
          ASMDraw_Sprite(
            *(_DWORD *)(v108 + 32),
            *(_DWORD *)(v108 + 20),
            *(_DWORD *)(v108 + 24),
            *(_DWORD *)(*(_DWORD *)(v108 + 12) + 16),
            *(_DWORD *)(*(_DWORD *)(v108 + 12) + 20),
            **(_DWORD **)(v108 + 12),
  ...
  v118 = v3->futur_objs;
  v3->futur_objs = v3->prior_objs;
  v3->prior_objs = v118;
  return 0;
}
// 56C9A0: using guessed type _DWORD __cdecl ASMDraw_Sprite(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD);
// 86BBF4: using guessed type int SDI_Capture_Info;
// 87D498: using guessed type int Clip_remove;
// 87D49C: using guessed type int Clip_draw;
...
//----- (00538590) --------------------------------------------------------
int __thiscall RGE_View::get_tile_mask_num(RGE_View *this, int map_col, int map_row, int map_width, int map_height, unsigned int VisibleMask)
{
  signed int v6; // ecx@1
  int v7; // ebp@5
  int v8; // edi@5
...
//----- (00538710) --------------------------------------------------------
int __thiscall RGE_View::draw_tile(RGE_View *this, RGE_Tile *tile, char terrain_type, __int16 x, __int16 y, __int16 map_col, __int16 map_row, char visible, int norm_draw, int fog_draw)
{
  RGE_View *v10; // esi@1
  RGE_Map *v11; // edx@1
...
//----- (00538B80) --------------------------------------------------------
void __thiscall RGE_View::draw_terrain_shape(RGE_View *this, int x, int y, TShape *shape, int index, char visible, char draw_attribute, int draw_normal, int draw_fog)
{
  RGE_View *v9; // esi@1
...
//----- (00538D60) --------------------------------------------------------
void __thiscall RGE_View::draw_terrain_obstruction_map(RGE_View *this, int x, int y, TShape *shape, int index, int TileX, int TileY)
{
  RGE_View *v7; // ebp@1
  int v8; // eax@1
  signed int v9; // esi@3
...
//----- (00538E60) --------------------------------------------------------
BOOL __thiscall RGE_View::Get_Cursor_Position(RGE_View *this, tagPOINT *Point, int adjustX, int adjustY)
{
  RGE_View *v4; // edi@1
  TDrawArea *v5; // eax@1
  int v6; // eax@4
...
//----- (00538F00) --------------------------------------------------------
int __thiscall RGE_View::Pick_Tile(RGE_View *this, int x, int y, int *Tile_X, int *Tile_Y)
{
  RGE_View *v5; // ebx@1
  RGE_Map *v6; // eax@1
  int v7; // edx@1
...
//----- (00539030) --------------------------------------------------------
void __thiscall RGE_View::get_tile_bounding_coords(RGE_View *this, int Tile_X, int Tile_Y, int *bx1, int *by1, int *bx2, int *by2)
{
  RGE_Tile *v7; // edx@1
  int v8; // esi@1
  int v9; // eax@1
...
//----- (005390D0) --------------------------------------------------------
int __thiscall RGE_View::pick_objects(RGE_View *this, int Xpos, int Ypos, int min_level, int max_level, int range, int max_confidence, int ignoreNeg)
{
  int v8; // edx@2
  int v9; // edi@2
  int v10; // ebp@3
...
//----- (005396F0) --------------------------------------------------------
int __thiscall RGE_View::pick_multi_objects(RGE_View *this, int Xpos1, int Ypos1, int Xpos2, int Ypos2, int min_level, int max_level, int player, char select_level, int ignoreNeg)
{
  RGE_View *v10; // ebx@1
  int v11; // ebp@1
  int v12; // esi@1
...
//----- (00539930) --------------------------------------------------------
int __thiscall RGE_View::pick_touched_object(RGE_View *this, DClipInfo_List *obj_list, int Xpos, int Ypos, int min_level, int max_level, int *touched_object_id)
{
  int v7; // eax@1
  int v8; // ebx@4
  int v9; // ecx@12
...
//----- (00539AA0) --------------------------------------------------------
__int16 __thiscall RGE_View::get_tile_picture(RGE_View *this, char terrain_type, char tile_type, __int16 map_col, __int16 map_row)
{
  RGE_Map *v5; // ecx@1
  int v6; // edx@1
  __int16 result; // ax@2
...
//----- (00539B90) --------------------------------------------------------
__int16 __thiscall RGE_View::get_border_picture(RGE_View *this, char border_type, char tile_type, char border_shape, __int16 map_col, __int16 map_row)
{
  char *v6; // ecx@1
  __int16 result; // ax@2
  int v8; // eax@3
...
//----- (00539C80) --------------------------------------------------------
int __thiscall RGE_View::get_border_edge_pictures(RGE_View *this, char border_type, char tile_type, char border_shape, __int16 map_col, __int16 map_row, int *top_index, int *right_index, int *left_index, int *bottom_index)
{
  RGE_View *v10; // esi@1
  char v11; // al@2
  int v12; // ecx@4
...
//----- (00539D90) --------------------------------------------------------
int __fastcall RGE_View::hit_tile(RGE_View *this, RGE_Tile *a2, RGE_Tile *tile, __int16 x, __int16 y, __int16 map_col, __int16 map_row, tagPOINT *mouse_pos)
{
  __int16 v8; // bp@1
  char v9; // al@2
  int v10; // eax@5
...
//----- (00539EC0) --------------------------------------------------------
RGE_Static_Object *__thiscall RGE_View::hit_object(RGE_View *this, RGE_Tile *tile, __int16 x, __int16 y, __int16 map_col, __int16 map_row, tagPOINT *mouse_pos, tagPOINT *start_mouse_pos, __int16 *item_scr_x, __int16 *item_scr_y, RGE_Static_Object *orig_picked_obj, char fog_flag)
{
  tagPOINT *v12; // ebx@3
  int v13; // edi@3
  int v14; // ebp@3
  ...
  __int16 max_x; // [sp+12h] [bp-1Ah]@28
...
//----- (0053A0D0) --------------------------------------------------------
int __thiscall RGE_View::start_scroll_view(RGE_View *this, char scroll_action_in, int x, int y, int ctrl_key, int shift_key)
{
  char v6; // bl@1
  RGE_View *v7; // esi@1
  int result; // eax@3
...
//----- (0053A290) --------------------------------------------------------
int __thiscall RGE_View::handle_scroll_view(RGE_View *this, int x, int y)
{
  int v3; // ebx@1
  RGE_View *v4; // esi@1
  int v5; // edi@1
  ...
  tagPOINT point; // [sp+28h] [bp-1Ch]@24
    ...
    switch ( v9 )
    {
      ...
      default:
        ...
        switch ( v54 )
        {
          ...
          case 9:
            v59 = v4->vfptr;
            (*(void (__thiscall **)(RGE_View *, int, int, int, int, signed int))&v4->vfptr[1].gap10[4])(
              v4,
              save_mouse_last_xa,
              xd,
              v3,
...
void __thiscall RGE_View::end_scroll_view(RGE_View *this)
{
  ...
  switch ( this->scroll_action )
  {
    ...
    case 9:
      v8 = this->vfptr;
      (*(void (__thiscall **)(RGE_View *, int, int, int, int, _DWORD))&this->vfptr[1].gap10[4])(
        this,
        this->mouse_down_x,
        this->mouse_down_y,
        this->mouse_down_x,
...
//----- (0053AAF0) --------------------------------------------------------
int __thiscall RGE_View::do_paint(RGE_View *this, int old_x, int old_y, int new_x, int new_y, int up_down)
{
  RGE_View *v6; // esi@1
  int result; // eax@2
  int v8; // edi@3
  ...
  if( (unsigned __int8)RGE_View::pick(this, 40, 0, new_x, new_y, &pick_info, 0) == 51 )
  {
    ...
    RGE_View::pick(v6, 40, 0, old_x, old_y, &pick_info, 0);
    HIWORD(v10) = HIWORD(rge_base_game);
    v11 = rge_base_game->brush_size;
    ...
    v6->real_old_map_row = v9;
    v6->real_old_map_col = v8;
    result = 1;
  }
  else
  {
...
//----- (0053ACD0) --------------------------------------------------------
void __thiscall RGE_View::add_overlay_sprite(RGE_View *this, TShape *theShape, int facet, int x, int y, int flags, int drawlevel, char *colorTable, int dispFunc, unsigned int DrawInterval)
{
  RGE_View *v10; // esi@1
  Ov_Sprite_Draw_Rec *v11; // eax@1
  Ov_Sprite_Draw_Rec *v12; // ecx@2
  ...
  if( v11 )
  {
    ...
    v11->world_y = y;
    v11->flags = flags;
    v11->drawLevel = drawlevel;
    v11->colortable = colorTable;
    v11->displayfunction = dispFunc;
    v11->DrawTimeInterval = DrawInterval;
    v11->LastDrawTime = 0;
  }
}

//----- (0053AD50) --------------------------------------------------------
bool __thiscall RGE_View::Object_Was_Displayed(RGE_View *this, int ObjectID, char InFogOK)
{
  DClipInfo_Node *v3; // eax@1
  bool result; // al@2
