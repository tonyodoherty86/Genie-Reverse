...
void __thiscall TRIBE_World::TRIBE_World(TRIBE_World *this)
{
  ...
  v1 = this;
  RGE_Game_World::RGE_Game_World((RGE_Game_World *)&this->vfptr);
  v1->controllingComputerPlayer = -1;
  v1->vfptr = (RGE_Game_WorldVtbl *)&TRIBE_World::`vftable';
  v1->tech = 0;
  v1->victory_type = 0;
  v1->artifact_count = 0;
  v1->ruin_count = 0;
...
// 577458: using guessed type unsigned __int8 (__thiscall *TRIBE_World::`vftable')(TRIBE_World *this, struct _iobuf *);

//----- (0052E020) --------------------------------------------------------
TRIBE_World *__thiscall TRIBE_World::`vector deleting destructor'(TRIBE_World *this, unsigned int __flags)
{
  TRIBE_World *v2; // esi@1

  v2 = this;
  TRIBE_World::~TRIBE_World(this);
  if ( __flags & 1 )
    operator delete(v2);
  return v2;
}
...
//----- (0052E220) --------------------------------------------------------
void __thiscall TRIBE_World::data_load_players_type(TRIBE_World *this, __int16 id, __int16 type, _iobuf *infile)
{
...
//----- (0052E2B0) --------------------------------------------------------
void __thiscall TRIBE_World::data_load_map(TRIBE_World *this, char *border_file, char *overlay_file, char *terrain_file, char *map_file, __int16 tile_width, __int16 tile_height, __int16 elev_height, RGE_Sound **sounds, char *terr_obj_file)
{
...
//----- (0052E350) --------------------------------------------------------
char __thiscall TRIBE_World::data_load_world(TRIBE_World *this, _iobuf *infile)
{
  TRIBE_World *v2; // esi@1
  _WORD *v3; // eax@1
  TRIBE_Tech *v4; // eax@2
  char tech_file[23]; // [sp+Ch] [bp-24h]@1
  int v7; // [sp+2Ch] [bp-4h]@1

  v2 = this;
  RGE_Game_World::data_load_world((RGE_Game_World *)&this->vfptr, infile);
  fscanf(infile, aS, tech_file);
  v3 = operator new(0xCu);
  v7 = 0;
  if ( v3 )
    v4 = (TRIBE_Tech *)TRIBE_Tech::TRIBE_Tech(v3, tech_file);
  else
    v4 = 0;
  v2->tech = v4;
  v2->victory_type = 0;
  v2->artifact_count = 0;
  v2->ruin_count = 0;
  v2->countdown_victory = 0;
  LODWORD(v2->countdown_clock) = 0;
  v2->score_displayed = 0;
  return 1;
}

//----- (0052E400) --------------------------------------------------------
char __userpurge TRIBE_World::init_player_type@<al>(TRIBE_World *this@<ecx>, int a2@<ebp>, int infile, __int16 index, char type)
{
...
//----- (0052E4C0) --------------------------------------------------------
void __thiscall TRIBE_World::map_init(TRIBE_World *this, int infile, TSound_Driver *sound_dvr)
{
...
//----- (0052E530) --------------------------------------------------------
void __thiscall TRIBE_World::command_init(TRIBE_World *this, int infile, TCommunications_Handler *com_hand)
{
  TRIBE_World *v3; // esi@1
...
//----- (0052E590) --------------------------------------------------------
void __userpurge TRIBE_World::scenario_init(TRIBE_World *this@<ecx>, char *a2@<ebp>, int infile, RGE_Game_World *world)
{
  TRIBE_World *v4; // esi@1
  T_Scenario *v5; // eax@1
...
//----- (0052E5F0) --------------------------------------------------------
void __thiscall TRIBE_World::scenario_init(TRIBE_World *this, RGE_Game_World *world)
{
  TRIBE_World *v2; // esi@1
  T_Scenario *v3; // eax@1
...
//----- (0052E650) --------------------------------------------------------
void __thiscall TRIBE_World::effects_init(TRIBE_World *this, int infile)
{
  TRIBE_World *v2; // esi@1
...
//----- (0052E6B0) --------------------------------------------------------
void __thiscall TRIBE_World::world_init(TRIBE_World *this, int infile, TSound_Driver *sound_dvr, TCommunications_Handler *com_hand)
{
  TRIBE_World *v4; // esi@1
  void *v5; // eax@1
  int v6; // eax@2
...
//----- (0052E750) --------------------------------------------------------
char __thiscall TRIBE_World::init(TRIBE_World *this, char *base_name, TSound_Driver *sound_dvr, TCommunications_Handler *com_hand)
{
  return RGE_Game_World::init((RGE_Game_World *)&this->vfptr, base_name, sound_dvr, com_hand);
}

//----- (0052E770) --------------------------------------------------------
void __thiscall TRIBE_World::base_save(TRIBE_World *this, int outfile)
{
  TRIBE_World *v2; // esi@1
...
//----- (0052E790) --------------------------------------------------------
void __thiscall TRIBE_World::save(TRIBE_World *this, int outfile)
{
  TRIBE_World *v2; // esi@1
...
//----- (0052E830) --------------------------------------------------------
void __userpurge TRIBE_World::load_player(TRIBE_World *this@<ecx>, int a2@<ebp>, int infile, char type, __int16 index)
{
  TRIBE_World *v5; // esi@1
  TRIBE_Gaia *v6; // eax@5
  int v7; // edi@5
...
//----- (0052E990) --------------------------------------------------------
void __thiscall TRIBE_World::setup_players(TRIBE_World *this, RGE_Player_Info *info)
{
...
//----- (0052EAC0) --------------------------------------------------------
void __thiscall TRIBE_World::check_destructables(TRIBE_World *this, __int16 player_id, __int16 obj_id, float col, float row, char delete_flag)
{
  __int16 v6; // bx@1
  RGE_Master_Static_Object *v7; // eax@1
  __int16 v8; // bp@4
  signed __int16 v9; // si@4
  __int16 v10; // di@4
  ...
  if ( v7 )
  {
    ...
    if ( rx > 0.0 || ry > 0.0 )
    {
      ...
      if ( v9 < 0 )
        v9 = 0;
      if ( (signed __int16)v11 >= v13->map_height )
        LOWORD(v11) = LOWORD(v13->map_height) - 1;
      if ( v9 <= (signed __int16)v11 )
      {
        v29 = v8;
        HIDWORD(v11) = 24 * v8;
        v30 = 24 * v8;
        v24 = v9;
        v28 = (signed __int16)v11 - v9 + 1;
        do
        {
          if ( v8 <= v10 )
          {
...
//----- (0052ECF0) --------------------------------------------------------
void __thiscall TRIBE_World::scenario_make_player(TRIBE_World *this, __int16 index, char player_type, char info_type, char master_player_id, char *name)
{
...
//----- (0052EDF0) --------------------------------------------------------
char __userpurge TRIBE_World::load_world@<al>(TRIBE_World *this@<ecx>, int a2@<ebp>, int infile1)
{
  TRIBE_World *v3; // esi@1
  char result; // al@1

  v3 = this;
  result = RGE_Game_World::load_world((RGE_Game_World *)&this->vfptr, a2, infile1);
  if ( result )
  {
...
//----- (0052EF30) --------------------------------------------------------
char __userpurge TRIBE_World::new_game@<al>(TRIBE_World *this@<ecx>, int a2@<eax>, int a3@<ebx>, int a4@<ebp>, int a5@<edi>, int a6@<esi>, RGE_Player_Info *info, int myPlayerNum)
{
  void *v8; // esp@1
...
LABEL_34:
    ...
    (*(void (__thiscall **)(RGE_Base_Game *))&v23->gap8[24])(rge_base_game);
    v125 = 256;
    v124 = &v146;
    ...
    (*(void (__thiscall **)(RGE_Base_Game *))&v39->gap8[24])(rge_base_game);
...
// 52EF30: could not find valid save-restore pair for ebx
// 52EF30: could not find valid save-restore pair for ebp
// 52EF30: could not find valid save-restore pair for edi
// 52EF30: could not find valid save-restore pair for esi
// 561AEE: using guessed type int _L43664();

//----- (00530370) --------------------------------------------------------
char __thiscall TRIBE_World::new_scenario(TRIBE_World *this, RGE_Player_Info *info, int random_seed_in)
{
  TRIBE_World *v3; // esi@1
  char result; // al@1
  signed int i; // ecx@1
...
//----- (005303F0) --------------------------------------------------------
char __thiscall TRIBE_World::check_game_state(TRIBE_World *this)
{
      ...
      if ( this->countdown_victory )
      {
        if ( this->countdown_clock >= 1.0 )
        {
          ...
          if ( v3 )
          {
            ...
            v6 = (signed __int16)(this->player_num - 1) < 0;
...
//----- (00530A70) --------------------------------------------------------
int __thiscall TRIBE_World::get_achievement(TRIBE_World *this, char achievement, char **info)
{
...
//----- (00530AC0) --------------------------------------------------------
void __thiscall TRIBE_World::send_cheat(TRIBE_World *this, __int16 cheat_code)
{
  TRIBE_Command::command_cheat((TRIBE_Command *)this->commands, this->curr_player, cheat_code);
}

//----- (00530AE0) --------------------------------------------------------
void __thiscall TRIBE_World::cheat(TRIBE_World *this, __int16 player, __int16 cheat_code)
{
  TRIBE_World *v3; // esi@1
  ...
  if ( RGE_Base_Game::allowCheatCodes(rge_base_game) )
  {
    switch ( cheat_code )
    {
      ...
      case 230:
        ...
        (*(void (__thiscall **)(int, signed int))(*(_DWORD *)v17 + 32))(v17, 2);
        v18 = ((int (*)(void))rge_base_game->vfptr->get_map_panel)();
        (*(void (__thiscall **)(int, signed int))(*(_DWORD *)v18 + 32))(v18, 2);
        break;
      case 231:
        RGE_Base_Game::set_map_fog(rge_base_game, 0);
        v19 = ((int (*)(void))rge_base_game->vfptr->get_view_panel)();
        (*(void (__thiscall **)(int, signed int))(*(_DWORD *)v19 + 32))(v19, 2);
        break;
      default:
        return;
    }
...
// 86BAB8: using guessed type unsigned __int8 die_die_die;

//----- (00531240) --------------------------------------------------------
void __thiscall TRIBE_World::fill_in_score(TRIBE_World *this, TRIBE_Zone_High_Score_Info *info, int score_group)
{
...
void __thiscall TRIBE_World::send_zone_score_info(TRIBE_World *this)
{
  ...
  if ( !this->sent_zone_score )
  {
    ...
    v3 = (signed __int16)(this->player_num - 1) < 0;
