...
//#endif
    ...
    public: TShape( char *filename, int resource_file_id );
    ...
    */
    private: bool Check_shape( int shape_num );
    ...
    public: bool shape_check(
        int check_x,
        int check_y,
        int shape_num );

    public: bool shape_draw(
        TDrawArea *drawarea,
        int x,
        int y,
        int shape_num,
    ...
    private: bool shape_draw_unclipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        int shape_num );

    private: bool shape_color_trans_unclipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        int shape_num,
    ...
    private: bool shape_shadow_unclipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        char *color_table );

    private: bool shape_draw_clipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        int clip_x0,
    ...
    private: bool shape_color_trans_clipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        int shape_num,
    ...
    private: bool shape_shadow_clipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        int clip_x0,
    ...
    private: bool shape_mirror_unclipped(
        TDrawArea *drawarea,
        int shape_x1,
        int shape_y0 );

    private: bool shape_mirror_color_trans_unclipped(
        TDrawArea *drawarea,
        int shape_x1,
        int shape_y0,
        int shape_num,
    ...
    private: bool shape_mirror_shadow_unclipped(
        TDrawArea *drawarea,
        int shape_x1,
        int shape_y0,
        char *color_table );

    private: bool shape_mirror_clipped(
        TDrawArea *drawarea,
        int shape_x1,
        int shape_y0,
        int clip_x0,
    ...
    private: bool shape_mirror_color_trans_clipped(
        TDrawArea *drawarea,
        int shape_x1,
        int shape_y0,
        int shape_num,
    ...
    private: bool shape_mirror_shadow_clipped(
        TDrawArea *drawarea,
        int shape_x1,
        int shape_y0,
        int clip_x0,
    ...
    private: bool shape_dithered_unclipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        int dx,
    ...
    private: bool shape_dithered_clipped(
        TDrawArea *drawarea,
        int shape_x0,
        int shape_y0,
        int clip_x0,
