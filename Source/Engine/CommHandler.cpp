...
char *TCommunications_Handler::WaitingOnNamedInfo(unsigned int PlayerNo)
{
...
char *TCommunications_Handler::WaitingOnInfo(unsigned int PlayerNo)
{
    TCommunications_Handler *v2; // esi@1
    char *result; // eax@2
...
void TCommunications_Handler::StopIfSyncFail(int b)
{
    this->Sync->SetDialogOnFail(b);
    this->Sync->SetStopOnFail(b);
}

void TCommunications_Handler::ShowSyncChatMsgs(int b)
{
    this->Sync->SendChatMsgsAtChecksum(b);
}

void TCommunications_Handler::DropPacketsIntentionally(int b)
{
    if( this->IntentionallyDropPackets = b ){
        L->Log("Dropping Packet");
    }
}

void TCommunications_Handler::SetStepMode(int b)
{
    this->StepMode = b;
}

void TCommunications_Handler::SetSpeedControl(int b)
{
    this->Speed->EnableSpeedControl(b);
}

int TCommunications_Handler::CalculatePlayerRange()
{
...
void TCommunications_Handler::Step(int Numsteps)
{
    this->TEST();
    this->Steps += Numsteps;
}

TCommunications_Handler::TCommunications_Handler(HWND *WinHandle, char MaxPlayers, TChat *ChatHandle, GUID AppGuid)
{
    ...
    v6 = this->RXPacketLength;
    if( v6 <= this->RXPacketLengthHigh )
        v6 = this->RXPacketLengthHigh;
    this->RXPacketLengthHigh = v6;
    this->RXPacketLength = 0;
    this->ReturnTXPacketSize = this->TXPacketLength;
    v7 = this->TXPacketLength;
    if( v7 <= this->TXPacketLengthHigh )
        v7 = this->TXPacketLengthHigh;
    this->TXPacketLengthHigh = v7;
    this->TXPacketLength = 0;
    this->OutQ = 0;
    v8 = (int)&this->NullGUID;
    this->InQ = 0;
    this->GTDSerialNo = 0;
    *(_DWORD *)v8 = 0;
    *(_DWORD *)(v8 + 4) = 0;
    *(_DWORD *)(v8 + 8) = 0;
    *(_DWORD *)(v8 + 12) = 0;
    this->CommunicationsStatus = 1;
    this->ApplicationGUID = AppGuid;
    v9 = (int)&this->SessionGUID;
    *(_DWORD *)v9 = this->NullGUID.x;
    *(_DWORD *)(v9 + 4) = *(_DWORD *)&this->NullGUID.s1;
    *(_DWORD *)(v9 + 8) = *(_DWORD *)&this->NullGUID.c[0];
    *(_DWORD *)(v9 + 12) = *(_DWORD *)&this->NullGUID.c[4];
    v10 = (int)&this->ServiceGUID;
    this->ServiceGUID.x = this->NullGUID.x;
    *(_DWORD *)(v10 + 4) = *(_DWORD *)&this->NullGUID.s1;
    *(_DWORD *)(v10 + 8) = *(_DWORD *)&this->NullGUID.c[0];
    *(_DWORD *)(v10 + 12) = *(_DWORD *)&this->NullGUID.c[4];
    this->HostHWND = WinHandle;
    this->Chat = ChatHandle;
    this->MaxGamePlayers = (unsigned __int8)MaxPlayers;
    ...
    this->CommunicationsVersionCode = 3025031;
    ...
    LODWORD(this->lastRXDataRate) = 0;
    LODWORD(this->lastTXDataRate) = 0;
    this->HoldCount = 0;
    ...
    this->PlayerOptions.LastSentTime = v37;
    this->AvgTurnTime = 0;
    this->PauseChangePending = 0;
    this->StepMode = 0;
    this->IntentionallyDropPackets = 0;
    strcpy(this->MyGameTitle, text_in);
    strcpy(this->MyFriendlyName, text_in);
    strcpy(this->MyFormalName, text_in);
    this->TickStart = 0;
    this->TickCount = 0;
    this->LastTimeoutMessageTime = 0;
    v38 = this->MaxGamePlayers;
    this->PlayerOptions.LowPlayerNumber = 1;
    this->PlayerOptions.HighPlayerNumber = v38;
    this->PlayerOptions.GameHasStarted = 0;
    this->PlayerOptions.ProgramState = 3;
    this->MeHost = 0;
    this->HaveHostInit = 0;
...
/*
RESENDER *RESENDER::`vector deleting destructor'(RESENDER *this, unsigned int __flags)
{
    RESENDER *v2; // esi@1
...
HOLDER *HOLDER::`vector deleting destructor'(HOLDER *this, unsigned int __flags)
{
    HOLDER *v2; // esi@1
    HOLDER *result; // eax@2
    ...
    if( __flags & 2 )
    {
        `eh vector destructor iterator'((int)this, 0x18u, this[-1].fromPlayer, (void (*)(void *))HOLDER::~HOLDER);
...
TCommunications_Handler::~TCommunications_Handler()
{
    ...
    {
        v8 = (void *)(v7 - 4);
        //`eh vector destructor iterator'(v7, 0x38u, *(_DWORD *)(v7 - 4), (void (*)(void *))RESENDER::~RESENDER);
        operator delete(v8);
    }
    v9 = (int)this->OnHold;
    if( v9 )
    {
        v10 = (void *)(v9 - 4);
        //`eh vector destructor iterator'(v9, 0x18u, *(_DWORD *)(v9 - 4), (void (*)(void *))HOLDER::~HOLDER);
        operator delete(v10);
    }
...
//----- (00426350) --------------------------------------------------------
void TCommunications_Handler::KillAnyMissingPlayers()
{
...
//----- (00426450) --------------------------------------------------------
void RESENDER::RESENDER(RESENDER *this)
{
    this->TimeSent = 0;
    this->ResendMsg = 0;
    this->Serial = 0;
...
//----- (00426470) --------------------------------------------------------
int TCommunications_Handler::AddCommand(unsigned int ExecuteOnTurn, void *command, unsigned int nBytes, int PFrom, char Sequence, int ControlCommand)
{
...
//----- (00426510) --------------------------------------------------------
int TCommunications_Handler::new_command(void *Command, int Size)
{
    return TCommunications_Handler::NewCommand(this, Command, Size, 0);
}

//----- (00426530) --------------------------------------------------------
int TCommunications_Handler::NewCommand(void *Command, int Size, int ControlCommand)
{
...
//----- (004265E0) --------------------------------------------------------
void HOLDER::HOLDER(HOLDER *this)
{
    this->HoldMsg = 0;
    this->Serial = 0;
    this->Length = 0;
...
//----- (00426630) --------------------------------------------------------
void TCommunications_Handler::LastWorldRandom(int lwr)
{
    RGE_Communications_Synchronize::SetLastWorldRandom(this->Sync, lwr);
}

//----- (00426650) --------------------------------------------------------
int TCommunications_Handler::DoCycle(unsigned int WorldTime)
{
    TCommunications_Handler *v2; // esi@1
    int result; // eax@2
...
//----- (00426D40) --------------------------------------------------------
int TCommunications_Handler::HasKicked(unsigned int p)
{
    return this->Kicked[p];
}

//----- (00426D50) --------------------------------------------------------
int TCommunications_Handler::SendPlayerName()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (00426DC0) --------------------------------------------------------
void TCommunications_Handler::LogRXMsg(unsigned int Serialno, unsigned int fromPlayer, unsigned int ExecuteOnTurn, char Command, char Sequence)
{
...
//----- (00427300) --------------------------------------------------------
void TCommunications_Handler::CheckPingTime(int Forced)
{
...
//----- (00427390) --------------------------------------------------------
BOOL TCommunications_Handler::TXPing(unsigned int ToPlayer)
{
    TCommunications_Handler *v2; // esi@1
...
//----- (00427440) --------------------------------------------------------
BOOL TCommunications_Handler::TXDebugPing()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (004274B0) --------------------------------------------------------
int TCommunications_Handler::FastSend(unsigned int ToDPID, void *Buffer, unsigned int BuffLen, int Priority, int Guaranteed)
{
...
//----- (00427600) --------------------------------------------------------
int TCommunications_Handler::PreprocessMessages(unsigned int dwSize, char *CommBuff, unsigned int dcoFromID, unsigned int dcoReceiveID, int fromHold)
{
...
//----- (00428270) --------------------------------------------------------
void TCommunications_Handler::NotifyWindow(COMMMESSAGES msg)
{
    TCommunications_Handler::NotifyWindowParam(this, msg, 0);
}

//----- (00428280) --------------------------------------------------------
void TCommunications_Handler::NotifyWindowParam(COMMMESSAGES msg, int lparam)
{
...
//----- (004282C0) --------------------------------------------------------
int TCommunications_Handler::EvaluatePlayerMessage(unsigned int len, unsigned int fromPlayer, unsigned int ExecuteOnTurn, char Command, char Sequence, char *Content, unsigned int ContentSize, unsigned int dcoFromID, unsigned int dcoReceiveID)
{
...
//----- (004286F0) --------------------------------------------------------
void TCommunications_Handler::SetPlayerStopTurn(unsigned int player, unsigned int Turn)
{
    this->PlayerStopTurn[player] = Turn;
}

//----- (00428710) --------------------------------------------------------
void TCommunications_Handler::CheckPlayerStopTurn(unsigned int Turn)
{
    TCommunications_Handler *v2; // edi@1
    unsigned int v3; // esi@1
    char *v4; // ebx@2
...
//----- (00428820) --------------------------------------------------------
int TCommunications_Handler::SendSharedData(int SendImmediately)
{
...
//----- (00428B10) --------------------------------------------------------
void TCommunications_Handler::DropDeadPlayer(unsigned int PlayerNo, unsigned int PlayerDPID)
{
...
//----- (00428DA0) --------------------------------------------------------
void TCommunications_Handler::EvaluateSystemMessage(unsigned int type, char *CommBuff, unsigned int dcoFromID, unsigned int dcoReceiveID)
{
    TCommunications_Handler *v5; // ebp@1
    char *v6; // ebx@3
    int v7; // ecx@3
...
//----- (00429760) --------------------------------------------------------
void TCommunications_Handler::SendGroupChatMsg(char *Text)
{
    TCommunications_Handler *v2; // edi@1
    unsigned int v3; // esi@1
    bool v4; // cf@1
...
//----- (004297D0) --------------------------------------------------------
void TCommunications_Handler::SendChatMsgAll(char *Text)
{
...
//----- (00429810) --------------------------------------------------------
void TCommunications_Handler::SendChatMsg(unsigned int GamerID, unsigned int DestPlayerNo, char *Text)
{
    TCommunications_Handler *v4; // esi@1
...
//----- (00429870) --------------------------------------------------------
int TCommunications_Handler::TXChat(unsigned int GamerID, char *DestMap, char *Text)
{
...
//----- (00429A30) --------------------------------------------------------
void TCommunications_Handler::SendSpeedChange(unsigned int Frames, unsigned int Granularity)
{
    TCommunications_Handler *v3; // esi@1
...
//----- (00429BD0) --------------------------------------------------------
unsigned int TCommunications_Handler::HiTurnAcknowledged()
{
    TCommunications_Handler *v1; // edi@1
    signed int v2; // esi@1
    char *v3; // ebx@2
...
//----- (00429CE0) --------------------------------------------------------
int TCommunications_Handler::SendChecksumMessage(unsigned int worldtime, unsigned int random, int csum1, int csum2, int csum3, int csum4, int csum5)
{
...
//----- (00429D90) --------------------------------------------------------
unsigned int TCommunications_Handler::ExecuteIncoming()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (0042A060) --------------------------------------------------------
void TCommunications_Handler::ClearRXForPlayer(unsigned int PlayerNo)
{
...
//----- (0042A130) --------------------------------------------------------
void TCommunications_Handler::ClearTXForPlayer(unsigned int PlayerNo)
{
    signed int v2; // edx@1
    unsigned int v3; // eax@1
...
//----- (0042A160) --------------------------------------------------------
void TCommunications_Handler::ClearRXTXForPlayer(unsigned int PlayerNo)
{
    TCommunications_Handler *v2; // esi@1
...
//----- (0042A180) --------------------------------------------------------
int TCommunications_Handler::StoreIncoming(unsigned int SerialNumber, char *InBuff, unsigned int Length, unsigned int dcoFromID, unsigned int dcoReceiveID)
{
...
//----- (0042A330) --------------------------------------------------------
int TCommunications_Handler::StoreForResend(unsigned int SerialNumber, char *OutCommBuff, unsigned int Length, unsigned int *ResendDestMap)
{
...
//----- (0042A540) --------------------------------------------------------
int TCommunications_Handler::TXAcknowledgeMessage(unsigned int serialno, unsigned int fromPlayer)
{
    TCommunications_Handler *v3; // esi@1
    int result; // eax@2
    _DWORD *v5; // edi@3
...
//----- (0042A650) --------------------------------------------------------
int TCommunications_Handler::RXAcknowledgeStoredMessage(unsigned int serialno, unsigned int fromPlayer)
{
...
//----- (0042A6E0) --------------------------------------------------------
int TCommunications_Handler::PurgeAcknowledgedStoredMessages()
{
    int v1; // ebp@1
    unsigned int v2; // edi@1
...
//----- (0042A800) --------------------------------------------------------
unsigned int TCommunications_Handler::SendStoredMessages()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (0042AD10) --------------------------------------------------------
int TCommunications_Handler::TXResendReply(unsigned int serial, unsigned int toPlayer)
{
    TCommunications_Handler *v3; // esi@1
    int result; // eax@2
    unsigned int v5; // ebx@3
...
//----- (0042B0A0) --------------------------------------------------------
int TCommunications_Handler::TXResendRequest(unsigned int serial, unsigned int toPlayer)
{
    TCommunications_Handler *v3; // edi@1
...
//----- (0042B200) --------------------------------------------------------
unsigned __int8 TCommunications_Handler::GetNextSequence(unsigned int ThisTurn)
{
...
//----- (0042B270) --------------------------------------------------------
int TCommunications_Handler::CommOut(unsigned int To, char MsgType, void *Msg, int Length, char ResendSeq)
{
...
//----- (0042B860) --------------------------------------------------------
void TCommunications_Handler::DestroyMultiplayerGame()
{
...
//----- (0042BAD0) --------------------------------------------------------
int TCommunications_Handler::GetCommunicationsStatus()
{
    TCommunications_Handler *v1; // esi@1
    int result; // eax@1
...
//----- (0042BAE0) --------------------------------------------------------
int TCommunications_Handler::UnlinkCurrentLevel()
{
    TCommunications_Handler *v1; // ebp@1
...
//----- (0042C5D0) --------------------------------------------------------
int TCommunications_Handler::UnlinkToLevel(COMMSTATUS lvl)
{
    TCommunications_Handler *v2; // esi@1
    int v3; // eax@1
    COMMSTATUS v4; // ebx@1
...
//----- (0042C690) --------------------------------------------------------
int TCommunications_Handler::AnalyzeCommunicationsStatus()
{
    TCommunications_Handler *v1; // ebx@1
    int result; // eax@3
...
//----- (0042C7F0) --------------------------------------------------------
BOOL TCommunications_Handler::IsPaused()
{
    return this->PlayerOptions.ProgramState == 4;
}
...
//----- (0042C840) --------------------------------------------------------
void TCommunications_Handler::LocalResumeGame(unsigned int p)
{
...
//----- (0042C860) --------------------------------------------------------
void TCommunications_Handler::LocalPauseGame(unsigned int p)
{
...
//----- (0042C880) --------------------------------------------------------
void TCommunications_Handler::SendPauseGame(int Pause)
{
    TCommunications_Handler *v2; // esi@1
...
//----- (0042C930) --------------------------------------------------------
void TCommunications_Handler::RequestPauseGame(int SendChatInfo)
{
    TCommunications_Handler *v2; // esi@1
...
//----- (0042C9A0) --------------------------------------------------------
void TCommunications_Handler::RequestResumeGame(int SendChatInfo)
{
    TCommunications_Handler *v2; // esi@1
...
//----- (0042CA20) --------------------------------------------------------
void TCommunications_Handler::SetRandomSeed(int val)
{
    TCommunications_Handler *v2; // esi@1
    int v3; // eax@2
...
//----- (0042CA90) --------------------------------------------------------
unsigned int TCommunications_Handler::GetRandomSeed()
{
    TCommunications_Handler *v1; // esi@1
    unsigned int v2; // eax@2
...
//----- (0042CAF0) --------------------------------------------------------
unsigned int TCommunications_Handler::WhoAmI()
{
    return this->Me;
}
...
//----- (0042CB30) --------------------------------------------------------
char *TCommunications_Handler::GetReadyPlayerStr()
{
    TCommunications_Handler *v1; // ebp@1
    unsigned int v2; // ecx@1
    char v3; // al@1
...
//----- (0042CC00) --------------------------------------------------------
PLAYERHUMANITY TCommunications_Handler::GetPlayerHumanity(unsigned int PlayerNo)
{
...
//----- (0042CC30) --------------------------------------------------------
void TCommunications_Handler::SetPlayerHumanity(unsigned int PlayerNo, PLAYERHUMANITY Type)
{
    TCommunications_Handler *v3; // esi@1
...
//----- (0042CC90) --------------------------------------------------------
int TCommunications_Handler::GetActivePlayerCount()
{
    TCommunications_Handler *v1; // edi@1
    signed int v2; // esi@1
    int v3; // ebx@1
...
//----- (0042CCD0) --------------------------------------------------------
int TCommunications_Handler::IsPlayerHuman(unsigned int PlayerNo)
{
...
//----- (0042CD10) --------------------------------------------------------
int TCommunications_Handler::IsPlayerComputer(unsigned int PlayerNo)
{
    int result; // eax@3
...
//----- (0042CD50) --------------------------------------------------------
char *TCommunications_Handler::GetCommInfo(char LineNum)
{
    char *v2; // edx@1
    TCommunications_Handler *v3; // ebx@1
    int v4; // ebp@1
...
//----- (0042D0E0) --------------------------------------------------------
char *TCommunications_Handler::GetPlayerName(unsigned int PlayerNo)
{
    char *result; // eax@2
...
//----- (0042D120) --------------------------------------------------------
void TCommunications_Handler::UpdatePlayerInformation(unsigned int dpID, char *AFriendlyName, char *AFormalName)
{
    int v4; // eax@2
    int v5; // esi@2
    char *v6; // edx@3
...
//----- (0042D180) --------------------------------------------------------
IDirectPlay3 *TCommunications_Handler::LaunchLobbyGame()
{
    TCommunications_Handler *v1; // esi@1
    RGE_Lobby *v2; // ecx@1
    int v3; // edi@1
...
//----- (0042D2D0) --------------------------------------------------------
void TCommunications_Handler::InitPlayerInformation(unsigned int PlayerNo, unsigned int dpID, char *FrName, char *FoName)
{
...
//----- (0042D3B0) --------------------------------------------------------
int TCommunications_Handler::SetGameTitle(char *Game)
{
...
//----- (0042D3E0) --------------------------------------------------------
void TCommunications_Handler::SetMyPlayerName(char *Name)
{
...
//----- (0042D440) --------------------------------------------------------
void TCommunications_Handler::SetPlayerName(unsigned int PlayerNo, char *Name)
{
    if( PlayerNo == this->Me )
...
//----- (0042D490) --------------------------------------------------------
void *TCommunications_Handler::SetWindowHandle(void *hwnd)
{
    void *result; // eax@1
...
//----- (0042D4A0) --------------------------------------------------------
int TCommunications_Handler::CreateDirectPlayConversation()
{
    TCommunications_Handler *v1; // edi@1
    char *v2; // esi@1
    int v3; // ebx@1
...
//----- (0042D590) --------------------------------------------------------
int TCommunications_Handler::CreateMultiplayerGame()
{
    TCommunications_Handler *v1; // esi@1
    TChat *v2; // ecx@1
    int v3; // eax@1
    ...
    *(_DWORD *)&dSess2.guidApplication.c[4] = v5;
    ...
    v6 = glpIDC->vfptr[8].QueryInterface((IUnknown *)glpIDC, (GUID *)&dSess2, (void **)2);
...
//----- (0042D960) --------------------------------------------------------
IDirectPlay3 *TCommunications_Handler::AddSelfPlayer()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (0042DA50) --------------------------------------------------------
int TCommunications_Handler::InitJoinGame()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (0042DA80) --------------------------------------------------------
IDirectPlay3 *TCommunications_Handler::JoinMultiplayerGame(GUID *GameGuid)
{
    TCommunications_Handler *v2; // esi@1
    ...
    if( glpIDC )
    {
        ...
        *(_DWORD *)&dSess2.guidApplication.c[4] = *(_DWORD *)&this->ApplicationGUID.c[4];
        ...
        v8 = glpIDC->vfptr[8].QueryInterface((IUnknown *)glpIDC, (GUID *)&dSess2, (void **)1);
        switch ( v8 )
        {
            case -2005466786:
...
//----- (0042DD70) --------------------------------------------------------
int TCommunications_Handler::GetMyMultiPlayerCaps()
{
    TCommunications_Handler *v1; // esi@1
    int result; // eax@2
    int v3; // edi@5
...
//----- (0042DEA0) --------------------------------------------------------
void TCommunications_Handler::SetApplicationGUID(GUID guid)
{
...
//----- (0042DEE0) --------------------------------------------------------
void TCommunications_Handler::SetServiceGUID(GUID inGuid)
{
    this->ServiceGUID = inGuid;
}

//----- (0042DF10) --------------------------------------------------------
void TCommunications_Handler::SetSessionGUID(GUID inGuid)
{
...
//----- (0042DF90) --------------------------------------------------------
void TCommunications_Handler::UpdatePlayer(unsigned int PlayerNo, int Notify)
{
...
//----- (0042E380) --------------------------------------------------------
int TCommunications_Handler::SetMyReadiness(int Ready, unsigned int User1, unsigned int User2, unsigned int User3, unsigned int User4, unsigned int User5, unsigned int User6, unsigned int User7)
{
...
//----- (0042E500) --------------------------------------------------------
int TCommunications_Handler::GetClientReadiness(unsigned int PlayerNo, int *Ready, unsigned int *User1, unsigned int *User2, unsigned int *User3, unsigned int *User4, unsigned int *User5, unsigned int *User6, unsigned int *User7)
{
...
//----- (0042E580) --------------------------------------------------------
int TCommunications_Handler::IsPlayerReady(unsigned int PlayerNo)
{
    int result; // eax@3
...
//----- (0042E5B0) --------------------------------------------------------
int TCommunications_Handler::ComputerPlayerGameStart()
{
    int result; // eax@2
...
//----- (0042E670) --------------------------------------------------------
int TCommunications_Handler::DPlayGetSessionDesc()
{
    TCommunications_Handler *v1; // ebx@1
    int result; // eax@2
    _DWORD *v3; // esi@3
...
//----- (0042E730) --------------------------------------------------------
int TCommunications_Handler::CommGetCaps()
{
    TCommunications_Handler *v1; // esi@1
    int result; // eax@2
...
//----- (0042E920) --------------------------------------------------------
int TCommunications_Handler::CloseSession()
{
    TCommunications_Handler *v1; // esi@1
    int v2; // edi@1
    int v3; // eax@3
...
//----- (0042E9B0) --------------------------------------------------------
int TCommunications_Handler::ReleaseComm()
{
    TCommunications_Handler *v1; // esi@1
    unsigned int v2; // eax@2
    int v3; // eax@2
...
//----- (0042EA10) --------------------------------------------------------
int TCommunications_Handler::Kick(unsigned int PlayerNo)
{
    TCommunications_Handler *v2; // esi@1
...
//----- (0042EB10) --------------------------------------------------------
IDirectPlay3 *TCommunications_Handler::DestroyMyPlayer()
{
    IDirectPlay3 *result; // eax@1
    TCommunications_Handler *v2; // edi@1
    int v3; // esi@4
...
//----- (0042EB60) --------------------------------------------------------
char *TCommunications_Handler::SetMyGameOptions(char *vpData, unsigned int dwSize)
{
    TCommunications_Handler *v3; // ebx@1
    char *result; // eax@2
...
//----- (0042EBF0) --------------------------------------------------------
char *TCommunications_Handler::GetMyGameOptions(unsigned int *dwSize)
{
...
//----- (0042EC40) --------------------------------------------------------
int __cdecl StringFromGUID(GUID *lpguid, unsigned __int16 *lpwsz)
{
...
//----- (0042ECC0) --------------------------------------------------------
void TCommunications_Handler::SetHostPlayerNumber(unsigned int PlayerNo)
{
    this->PlayerOptions.HostPlayerNumber = PlayerNo;
}

//----- (0042ECD0) --------------------------------------------------------
unsigned int TCommunications_Handler::GetHostPlayerNumber()
{
...
//----- (0042EF60) --------------------------------------------------------
void TCommunications_Handler::OutOfSync(int Status, unsigned int StopTime)
{
...
//----- (0042EF80) --------------------------------------------------------
int TCommunications_Handler::SendZoneMessage(char *Data, unsigned int dwSize)
{
    TCommunications_Handler *v3; // esi@1
    int result; // eax@2
    GUID v5; // ST08_16@3
...
//----- (0042F110) --------------------------------------------------------
void TCommunications_Handler::ForcePlayerEnumeration()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (0042F140) --------------------------------------------------------
void TCommunications_Handler::ForcePlayerDestroyAndCreate()
{
    TCommunications_Handler *v1; // esi@1
...
//----- (0042F230) --------------------------------------------------------
void TCommunications_Handler::SetSpeedV1(unsigned int v1)
{
...
//----- (0042F250) --------------------------------------------------------
void TCommunications_Handler::SetSpeedV2(unsigned int v2)
{
...
//----- (0042F270) --------------------------------------------------------
int TCommunications_Handler::IsPlayerOutOfSync(unsigned int pnum, unsigned int worldturn)
{
