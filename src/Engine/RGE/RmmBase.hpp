...
public:
    ...
    class RGE_Random_Map_Module *parent;
    ...
    void share_resources(char **search_map_pointer, char ***search_map_rows_pointer, Map_Stack **stack_array_pointer, Map_Stack ***stack_offsets_pointer);
